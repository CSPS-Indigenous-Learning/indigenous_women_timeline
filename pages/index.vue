      ...
      <b-row class="persons-container" align-v="start">
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1600" :key="'1600_' + index" :info="person" :id="'1600_' + index" @open="closeAllOthers(person)" :ref="'person1600_' + index" :aria-posinset="index + 1" :aria-setsize="totalNumber"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1700" :key="'1700_' + index" :info="person" :id="'1700_' + index"  @open="closeAllOthers(person)" :ref="'person1700_' + index" :aria-posinset="persons1600.length + index + 1" :aria-setsize="totalNumber"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1800" :key="'1800_' + index" :info="person" :id="'1800_' + index" @open="closeAllOthers(person)" :ref="'person1800_' + index" :aria-posinset="persons1600.length + persons1700.length + index + 1" :aria-setsize="totalNumber"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1900" :key="'1900_' + index" :info="person" :id="'1900_' + index" @open="closeAllOthers(person)" :ref="'person1900_' + index" :aria-posinset="persons1600.length + persons1700.length + persons1800.length + index + 1" :aria-setsize="totalNumber"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1920" :key="'1920_' + index" :info="person" :id="'1920_' + index" @open="closeAllOthers(person)" :ref="'person1920_' + index" :aria-posinset="persons1600.length + persons1700.length + persons1800.length + persons1900.length + index + 1" :aria-setsize="totalNumber"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1940" :key="'1940_' + index" :info="person" :id="'1940_' + index" @open="closeAllOthers(person)" :ref="'person1940_' + index" :aria-posinset="persons1600.length + persons1700.length + persons1800.length + persons1900.length + persons1920.length + index + 1" :aria-setsize="totalNumber"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1960" :key="'1960_' + index" :info="person" :id="'1960_' + index" @open="closeAllOthers(person)" :ref="'person1960_' + index" :aria-posinset="persons1600.length + persons1700.length + persons1800.length + persons1900.length + persons1920.length + persons1940.length + index + 1" :aria-setsize="totalNumber"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons2000" :key="'2000_' + index" :info="person" :id="'2000_' + index" @open="closeAllOthers(person)" :ref="'person2000_' + index" :aria-posinset="persons1600.length + persons1700.length + persons1800.length + persons1900.length + persons1920.length + persons1940.length + persons1960.length + persons1980.length + index + 1" :aria-setsize="totalNumber"></person>
          </transition-group>
        </b-col>
      </b-row>
    </b-container>
