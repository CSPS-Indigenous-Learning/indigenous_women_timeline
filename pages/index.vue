...
<script>
  ...
  export default{
    ...
    data(){
      return{
        persons1600: Object.values(this.$i18n.t('persons').d1600),
        persons1700: Object.values(this.$i18n.t('persons').d1700),
        persons1800: Object.values(this.$i18n.t('persons').d1800),
        persons1900: Object.values(this.$i18n.t('persons').d1900),
        persons1920: Object.values(this.$i18n.t('persons').d1920),
        persons1940: Object.values(this.$i18n.t('persons').d1940),
        persons1960: Object.values(this.$i18n.t('persons').d1960),
        persons1980: Object.values(this.$i18n.t('persons').d1980),
        persons2000: Object.values(this.$i18n.t('persons').d2000)
      }
    },
