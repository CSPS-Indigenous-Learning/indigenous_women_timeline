      ...
      <b-row class="persons-container" align-v="start">
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1600" :key="'1600_' + index" :info="person" :id="'1600_' + index" @open="closeAllOthers(person)" :ref="'person1600_' + index"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1700" :key="'1700_' + index" :info="person" :id="'1700_' + index"  @open="closeAllOthers(person)" :ref="'person1700_' + index"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1800" :key="'1800_' + index" :info="person" :id="'1800_' + index" @open="closeAllOthers(person)" :ref="'person1800_' + index"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1900" :key="'1900_' + index" :info="person" :id="'1900_' + index" @open="closeAllOthers(person)" :ref="'person1900_' + index"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1920" :key="'1920_' + index" :info="person" :id="'1920_' + index" @open="closeAllOthers(person)" :ref="'person1920_' + index"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1940" :key="'1940_' + index" :info="person" :id="'1940_' + index" @open="closeAllOthers(person)" :ref="'person1940_' + index"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1960" :key="'1960_' + index" :info="person" :id="'1960_' + index" @open="closeAllOthers(person)" :ref="'person1960_' + index"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons1980" :key="'1980_' + index" :info="person" :id="'1980_' + index" @open="closeAllOthers(person)" :ref="'person1980_' + index"></person>
          </transition-group>
        </b-col>
        ...
        <b-col cols="10">
          <transition-group name="timeline-fade" tag="div" class="row">
            <person v-for="(person, index) in persons2000" :key="'2000_' + index" :info="person" :id="'2000_' + index" @open="closeAllOthers(person)" :ref="'person2000_' + index"></person>
          </transition-group>
        </b-col>
      </b-row>
    </b-container>
    ...
    methods:{
      filterPersons(arr, decade){
        ...
        return arr.filter(function(person){
          if(that.isActivated(decade, that.periods) && that.checkTags(person) && (!that.$refs.topbar || that.checkFilterText(person))){
            return true;
          }
          else{
            return false;
      ...
      checkFilterText(info){
        if(!this.$refs.topbar){
          ...
          if(this.$refs.topbar.filterText == "" || info.name.toLowerCase().indexOf(this.$refs.topbar.filterText.toLowerCase()) >= 0 || info.birth.toLowerCase().indexOf(this.$refs.topbar.filterText.toLowerCase()) >= 0 || info.death.toLowerCase().indexOf(this.$refs.topbar.filterText.toLowerCase()) >= 0 || info.content.toLowerCase().indexOf(this.$refs.topbar.filterText.toLowerCase()) >= 0){
            return true;
          }
          else{
            return false;
...
<i18n>

  {
    "en": {
      ...
      "nothingToShow": "Your selection of categories, years and text does not return any women."
    },
    "fr": {
      ...
      "nothingToShow": "Votre sélection de catégories, d'années et de texte ne retourne aucune femme."
    }
  }
