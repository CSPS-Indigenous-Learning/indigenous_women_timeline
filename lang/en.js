  ...
  persons: {
    ...
    d1700: {
      0: {
        ...
        tags: ["politics"],
        group: ["inuit"],
        content: "<p>Mikak, Labrador Inuk, daughter of Inuk chief Nerkingoak, is one of the first Inuit to emerge as a distinct individual in the history of the relations between the Europeans and the natives in Labrador. In 1765 the Moravian Brethren sent four missionaries on an exploratory expedition to contact the Labrador Inuit. From the British base of Chateau Bay on the Strait of Belle Isle the missionaries visited nearby encampments of Inuit who had come south for summer trade. A sudden September storm forced the missionaries Jens Haven and Christian Larsen Drachart to stay overnight in the tent of a native religious leader or angakok. Mikak was present in the tent, learned the names of the missionaries, and memorized a prayer taught her by Drachart.</p><p>Mikak’s next known contact with Europeans occurred under less happy circumstances. In November 1767 an Inuit band attacked Nicholas Darby’s fishing station at Cape Charles, northeast of Chateau Bay, killing some men and taking away boats. A detachment from Fort York at Chateau Bay pursued the Inuit, killing the men and capturing the women and children. Mikak was carried to Chateau Bay with the other prisoners and spent the winter at the blockhouse. Her evident intelligence attracted the attention of the second in command of the garrison, Francis Lucas. With his help she picked up English quickly and in return taught him some Inuit words. In the autumn of 1768 Hugh Palliser, then governor of Newfoundland, arranged for Mikak, her son Tootac, and an older boy, Karpik, to be taken to England. His intention was to impress them with the power and grandeur of England so that they would advocate cooperation and trade when they returned to their people. Upon arrival in London Mikak again met Jens Haven, and learned that the Moravians were eager to secure a land grant for a mission post on the Labrador coast.</p><p>In an age when &ldquo;noble savages&rdquo; were in fashion, Mikak was patronized by London society. Among other gifts, she received from Augusta, Dowager Princess of Wales, a costly dress trimmed with gold lace. At the instance of the naturalist Joseph Banks Mikak sat to the society painter John Russell. The portrait was exhibited at the Royal Academy of Arts and now hangs in the Ethnological Institute at Göttingen University (Federal Republic of Germany). Clothed in the dress given her by the dowager princess, Mikak looks out with a shrewd and observant eye. She repeatedly urged the cause of the Moravians before her well-connected patrons, and partly because of her efforts the Moravians received their grant in May 1769. The missionaries, however, disapproved of Inuit being taken to England, feeling that contact with European society spoiled them for the life to which they must return.</p><p>Mikak was highly intelligent, observant, and quick to learn. She could be generous and kind, as when she pleaded the cause of the Moravians in London and helped them to settle in Labrador. She seems to have remained her own woman, receptive to the Moravians’ teachings but not without a degree of reserve, enjoying European society but conscious of her influence and place in the Inuit community.</p>",
        sources: [{ link: "http://www.biographi.ca/en/bio/mikak_4E.html", name: "MIKAK (Micoc, Mykok)&ThinSpace;&ndash;&ThinSpace;Dictionary of Canadian Biography" }]
      },
    },
    d1800: {
      0: {
    ...
    d1900: {
      ...
      2: {
        ...
        death: "1996",
        hideDates: false,
        imgSrc: "mary_two_axe_earley",
        tags: ["politics"],
        group: ["first"],
        content: "<p>Mary Two-Axe Earley, Kanien’kehá:ka (Mohawk) elder, advocate for women and children, human rights activist (born on the Kahnawà:ke reserve, <abbr title=\"Quebec\">QC</abbr>). Mary Two-Axe Earley was a pioneer and architect of the Canadian women’s movement. Her political activism helped to forge a coalition of allies to challenge Canadian laws that discriminated against Indigenous women. The great bulk of her political advocacy spanned the last three decades of her life, and she was particularly active in the 1960s, 1970s and 1980s.</p><p>At the age of 18, during a time of limited employment opportunities for people on reserves in Canada, Two-Axe Earley left her ancestral land and migrated to the United States in search of work. She settled in Brooklyn, New York, where a Mohawk community, &ldquo;Little Caughnawaga,&rdquo; grew around the steel and iron industries during the boom of the 1920s. It was here that she met and married Edward Earley, an electrical engineer of Irish-American origin. She and her husband bore two children, Rosemary and Edward Earley.</p><p>Mary Two-Axe Earley was a courageous and vocal agent of constitutional change for women marginalized by the Indian Act. The work of Two-Axe Earley eventually culminated in Bill C-31 receiving Royal Assent on 28 June 1985. Bill C-31 amended the Indian Act to outline a process of reinstatement for some women who had lost their status because of section 12(1)(b). The following week, on 5 July 1985, Two-Axe Earley had her status reinstated at a Toronto ceremony with a letter from David Crombie, minister of Indian Affairs and Northern Development (now Indigenous and Northern Affairs Canada). Her work remains significant to the legacy of the women’s movement and Indigenous women’s activism in Canada. </p><p>On 17 October 1979, Mary Two-Axe Earley was recognized for her work with Indian Rights for Indian Women, and received the Governor General’s Persons Case Award for her notable contributions to the advancement of equality and rights for women and girls in Canada. In the 1980s, Two-Axe Earley was celebrated by York University in Toronto with an honorary doctorate of law, made an Officer of the National Order of Québec (<span lang=\"fr\">Ordre national du Québec</span>) in 1985 and issued a National Aboriginal Achievement Award in 1996 (now called the Indspire Award).</p><p>Following three decades of activism, Mary Two-Axe Earley fell ill of respiratory illness. She left her earthly body on the same reserve where she was born, on 21 August 1996, at the age of 84. Before her death, she reaped the rewards of the constitutional changes she herself fought to make. As per her wishes, Two-Axe Earley was buried in a Catholic cemetery on the Kahnawà:ke reserve.</p>",
        sources: [{ link: "https://www.thecanadianencyclopedia.ca/en/article/mary-two-axe-earley", name: "Mary Two-Axe Earley&ThinSpace;&ndash;&ThinSpace;the Canadian Encyclopedia" }]
      },
      3: {
        name: "Ellen Neel",
        birth: "1916",
    ...
    d1920: {
      ...
      4: {
        ...
        sources: [{ link: "https://www.thecanadianencyclopedia.ca/en/article/kenojuak-ashevak", name: "Kenojuak Ashevak&ThinSpace;&ndash;&ThinSpace;The Canadian Encyclopedia" }, { link: "https://en.wikipedia.org/wiki/Kenojuak_Ashevak", name: "Kenojuak Ashevak&ThinSpace;&ndash;&ThinSpace;Wikipedia" }]
      },
      5: {
      ...
      11: {
        ...
        death: "",
        hideDates: false,
        imgSrc: "alanis_obomsawin",
        tags: ["media"],
        group: ["first"],
        content: "<p>Alanis Obomsawin, <abbr title=\"Companion of the Order of Canada\">CC</abbr>, <abbr title=\"Grand Officer of the Order of Quebec\">GOQ</abbr>, filmmaker, singer, artist, storyteller (born 31 August 1932 near Lebanon, New Hampshire). Alanis Obomsawin is one of Canada’s most distinguished documentary filmmakers. She began her career as a professional singer and storyteller before joining the National Film Board (<abbr>NFB</abbr>) in 1967. Her award-winning films address the struggles of Indigenous peoples in Canada from their perspective, giving prominence to voices that have long been ignored or dismissed. A Companion of the Order of Canada and a Grand Officer of the <span lang=\"fr\">Ordre national du Québec</span>, she has received the <span lang=\"fr\">Prix Albert-Tessier</span> and the Canadian Screen Awards’ Humanitarian Award, as well as multiple Governor General’s Awards, lifetime achievement awards and honorary degrees.</p><p>A member of the Abenaki Nation, Obomsawin, whose last name means &ldquo;pathfinder,&rdquo; returned with her family to the Odanak reserve near Sorel, Quebec, when she was six months old. Her father was a guide and a medicine maker, and her mother ran a boarding house.</p><p>Following her debut as a singer at a concert at New York City’s Town Hall in 1960, Alanis Obomsawin made appearances on reserves, in schools and prisons, at music festivals and on television. In 1966, she was profiled on the <abbr title=\"Canadian Broadcasting Corporation\">CBC</abbr> program Telescope for her activism and &ldquo;near superhuman&rdquo; efforts to fund&ThinSpace;&ndash;&ThinSpace;through donations, concerts and lectures&ThinSpace;&ndash;&ThinSpace;a swimming pool for the Odanak reserve after the local river was deemed too polluted.</p><p>After noticing her in the <abbr title=\"Canadian Broadcasting Corporation\">CBC</abbr> Telescope feature in 1966, Wolf Koenig and Bob Verrall, producers at the National Film Board (<abbr>NFB</abbr>), hired Obomsawin as a consultant on projects that related to First Nations peoples. In 1971, she directed her first film, Christmas at Moose Factory, and in 1977 she became a permanent staff member at the <abbr title=\"National Film Board\">NFB</abbr>. Committed to redressing the invisibility of Indigenous peoples, Alanis Obomsawin’s filmmaking style resides in the unique ability to pair Indigenous oral traditions with methods of documentary cinema.</p><p>She was a board member of the <abbr title=\"National Film Board\">NFB</abbr> Indigenous unit, Studio One, and an advisor for New Initiatives in Film, a program for women of colour and Indigenous women in the <abbr title=\"National Film Board\">NFB</abbr> women’s unit, Studio D. She has served on the board of directors for Aboriginal Voices, the Aboriginal Peoples Television Network (<abbr>APTN</abbr>), the Public Broadcasting Association of Quebec, National Geographic International and the Public Broadcasting System (<abbr>PBS</abbr>) in Vermont. She has also chaired the board of directors of the Native Women’s Shelter of Montreal and served on the Canada Council’s First Peoples Advisory Board.</p>",
        sources: [{ link: "https://www.thecanadianencyclopedia.ca/en/article/alanis-obomsawin", name: "Alanis Obomsawin&ThinSpace;&ndash;&ThinSpace;The Canadian Encyclopedia" }]
      },
      12: {
        name: "Freda Ahenakew",
        birth: "1932",
      ...
      21: {
        ...
        sources: [{ link: "https://www.portageandmainpress.com/Contributors/W/Wheeler-Bernelda", name: "Bernelda Wheeler&ThinSpace;&ndash;&ThinSpace;Portage &amp; Main Press" }, { link: "https://thestarphoenix.remembering.ca/obituary/bernelda-wheeler-1066586332", name: "Bernelda Wheeler&ThinSpace;&ndash;&ThinSpace;Saskatoon Star Phoenix" }]
      },
      22: {
        name: "Doreen Spence",
        birth: "1937",
    ...
    d1940: {
      ...
      7: {
        name: "Bibiane Courtois",
        birth: "1947",
        death: "",
        hideDates: false,
        imgSrc: "bibiane_courtois",
        tags: ["healthcare"],
        group: ["first"],
        content: "<p>Bibiane Courtois lives fifteen minutes from Mashteuiatsh, in <span lang=\"fr\">Lac-Saint-Jean</span>. However, it was the Indian Act that forced her to leave the area when she married a non-Native at age 21. Due to the Indian Act, she lost her status as an Aboriginal woman. It was as director of the board of directors, then as president of Quebec Native Women that she led her battle in the 1980s. In 1985, the Progressive Conservative government of Brian Mulroney amended the Indian Act, allowing Indigenous people to regain their status. A victory both sweet and bitter for Bibiane Courtois, this issue having deeply divided the indigenous communities of the country. However, this reform enabled her to return to her community as a nurse, after having practiced her profession for fifteen years in Alma, in <span lang=\"fr\">Lac-Saint-Jean</span>. During her years of practice, Bibiane Courtois contributed to the development of health care offered in her community by setting up a maternal and child health program. She received the Insignia of Merit from the <span lang=\"fr\">Ordre des infirmières du Québec</span> in 1998.</p><p>Bibiane Courtois' career also led her to sit on the Human Rights Commission and the Council on the Status of Women. The rights of Indigenous people and First Nations women are at the heart of her concerns. If women victims of violence, missing or murdered have often made the headlines, she hopes today that their courage will finally be put forward. A culture that she also promoted as director of the Amerindian Museum of Mashteuiatsh from 2003 to 2007. For Bibiane Courtois, women are an important pillar in the transmission of culture. It is in this spirit that she has been fashioning wooden sculptures for her children for several years.</p>",
        sources: [{ link: "https://ici.radio-canada.ca/espaces-autochtones/1086388/bibiane-courtois-femme-de-tete-et-de-coeur", name: "<span lang=\"fr\">Bibiane Courtois&nbsp;: femme de tête et de c&oelig;ur&ThinSpace;&ndash;&ThinSpace;Radio-Canada Espaces Autochtones</span>" }]
      },
      8: {
        name: "Joséphine Bacon",
        birth: "1947",
        death: "",
        hideDates: false,
        imgSrc: "josephine_bacon",
        tags: ["literature"],
        group: ["first"],
        content: "<p>Joséphine Bacon, born April 23, 1947, is an Innu poet, lyricist and producer from Pessamit, Canada. She writes in French and in Innu-aimun. She is considered a flagship author of Quebec.</p><p>Joséphine Bacon was born in an Innu community formerly called Bersimis, then Betsiamites, before becoming Pessamit, located 50 kilometers west of <span lang=\"fr\">Baie-Comeau</span>. She lived the first five years of her semi-nomadic life in Nutshimit, within the lands of her people. She was sent to boarding school in Maliotenam, 16 km east of <span lang=\"fr\">Sept-Îles</span>, but managed to avoid complete uprooting by rubbing shoulders with young people from surrounding communities, which allowed her to converse in her mother tongue. In her early twenties, Joséphine left Maliotenam for Quebec City to take secretarial courses. She speaks mostly in French, sometimes in English. She continues to chat in Innu-aimun with her few friends who have come along with her. Joséphine was traveling to Ottawa for six months to participate in training offered by the Office of Aboriginal Affairs. In 1968, she went to Montreal to find work. After a few unsuccessful attempts, she found herself on the street. She survived thanks to a few jobs before meeting anthropologists, Rémi Savard, Sylvie Vincent and José Mailhot, for whom she became a translator. She worked as a translator-interpreter with the elders of the Innu of Labrador and Quebec, bearers of oral traditions, and transcribes many founding myths for them. She thus re-appropriates the language of Nutshimit.</p><p>In addition to her transcription and research assistant work, she also works with linguists, became a translator and collaborates with filmmakers, including Gilles Carle and Arthur Lamothe. Thanks to training from the National Film Board of Canada, she acquired the knowledge necessary to become a documentary filmmaker herself. Her first achievement, now untraceable, tells us about the meeting of Innu elders and Kahnawake clan mothers. Joséphine Bacon directed Tshishe Mishtikuashisht, <span lang=\"fr\">Le petit grand European</span>, Johan Beetz in 1997 and Ameshkuatan, <span lang=\"fr\">Les sorties du beaver</span> in 1978. She took part in the thirteen programs of the television series Mupu (2002), the Carcajou Mikun series, Finding our talk, with the Mushkeg Nutaq productions, and Innu-Assi&ThinSpace;&ndash;&ThinSpace;with Manitu productions.</p><p>In 2009, it was with <span lang=\"fr\">Mémoire encrier</span> that she published her first collection <span lang=\"fr\">Batons à message</span> / Tshissinuatshitakana. It was written with nomads in love with the great outdoors in mind, and received the Readers' Prize from the Montreal Poetry Market in 2010 for his poem &ldquo;Draw me the tree&rdquo;. Continuing her collaboration with the <span lang=\"fr\">Mémoire Encrier</span> publishing house, she published a duet with José Acquelin <span lang=\"fr\">Nous suis tous des sauvage</span> published in 2011 and <span lang=\"fr\">Un thé dans la toundra</span> / Nipishapui nete mushuat released in 20133, and which was a finalist for Governor General and at the Grand Prix du livre de Montréal. Her most recent publication, the collection Uiesh Somewhere (2018), won her the 2019 Bookstore Prize. Joséphine Bacon has been invited to Colombia, France, Russia, Armenia and Haiti to participate in various poetry events.</p><p>She has been teaching Innu-aimun for forty years and gives numerous writing workshops and conferences in universities, CEGEPs and in several aboriginal communities in Quebec such as in her native village Pessamit or elsewhere such as in Escoumins, Mashteuiatsh, Natashquan, Obedjiwan, Sept-Îles and Odanak. She is also working on the translation of various Innu-aimun writings into French. In 2018, he was honored on the occasion of the Great Night of Poetry taking place in the village of <span lang=\"fr\">Saint-Venant-de-Paquette</span>, thanks to Jean-François Létourneau who spoke with the Cultural Factory.</p><p><span lang=\"fr\">Éditions Mémoire Encrier</span> in May 2010. She holds an honorary doctorate from the University of Laval. She won the Ostana International Prize for Writing in the Mother Tongue. In addition, for her book <span lang=\"fr\">Un thé dans la toundra</span>, she was a finalist for the Governor General's Prize and the <span lang=\"fr\">Grand Prix du livre de Montréal</span> in 2014. In 2018, she was named a Companion of the <span lang=\"fr\">Ordre des arts et des lettres du Québec</span>.</p>",
        sources: [{ link: "https://fr.wikipedia.org/wiki/Jos%C3%A9phine_Bacon", name: "<span lang=\"fr\">Joséphine Bacon&ThinSpace;&ndash;&ThinSpace;Wikipédia</span>" }]
      },
      9: {
        name: "Mary May Simon",
        birth: "1947",
        ...
        hideDates: false,
        imgSrc: "mary_simon",
        imgCaption: "Her Excellency the Right Honourable Mary May Simon, Governor General and Commander-in-Chief of Canada",
        tags: ["politics"],
        group: ["inuit"],
        content: "<p>Her Excellency The Right Honourable Mary May Simon, <abbr title=\"Companion of the Order of Canada\">C.C.</abbr>, <abbr title=\"Commander of the Order of Military Merit\">C.M.M.</abbr>, C.O.M., <abbr title=\"Officer of the Ordre national du Québec\">O.Q.</abbr>, <abbr title=\"Canadian Forces Decoration\">C.D.</abbr>, was installed as the 30<sup>th</sup> governor general of Canada on July 26, 2021. She has attained national and international recognition for her work on Arctic and Indigenous issues and as an advocate for Inuit rights and culture. Born in Kangiqsualujjuaq, Nunavik (Quebec), Ms. May Simon began her career as a radio broadcaster with the <abbr title=\"Canadian Broadcasting Corporation\">CBC</abbr> Northern Service (now <abbr title=\"Canadian Broadcasting Corporation\">CBC</abbr> North) in the 1970s. Following this, she held a series of executive positions with the Northern Quebec Inuit Association and Inuit Tapiriit Kanatami, centred on negotiating the first land claims agreement in Canada. As President of Makivik Corporation, she was directly involved with the implementation of the James Bay and Northern Quebec Agreement, and with the protection and promotion of Inuit rights under that agreement.</p><p>Along with fellow Indigenous leaders, she was actively involved in the negotiations leading to the 1982 patriation of the Canadian Constitution, which formally entrenched Aboriginal and treaty rights in the supreme law of Canada. She later joined the Executive Council of the Inuit Circumpolar Conference (now the Inuit Circumpolar Council), for which she served two terms as President. She was Commissioner of the Nunavut Implementation Commission and Policy Co-Director of the Royal Commission on Aboriginal Peoples. From 1994 to 2003, Ms. May Simon served as Ambassador for Circumpolar Affairs, becoming the first Inuk to hold an ambassadorial position. During this time, she negotiated the creation of the Arctic Council. Concurrently, she served as Ambassador of Canada to Denmark from 1999 to 2001. Beginning in 2006, Ms. May Simon served two terms as the President of Inuit Tapiriit Kanatami. In 2008, in the House of Commons, she delivered a response on behalf of Inuit to the formal apology on residential schools. She is the founder of the Arctic Children and Youth Foundation and, until 2014, she was the Chairperson of the National Committee on Inuit Education. In 2017, as the Minister’s Special Representative, Ms. May Simon delivered a report to the Minister of Indigenous and Northern Affairs on A new Shared Arctic Leadership Model, setting the stage for important policy and program development in support of the Arctic and its residents.</p><p>Among other distinctions, Ms. May Simon is an Officer of the Order of Canada, and an Officer of the <span alng=\"fr\">Ordre national du Québec</span>. She is also a recipient of the Governor General's Northern Medal, the Gold Order of Greenland, the National Aboriginal Achievement Award, the Gold Medal of the Canadian Geographical Society, and the Symons Medal.</p><p><strong>Photo credit:</strong> Sgt Johanie Maheu, Rideau Hall &copy; OSGG-BSGG, 2021</p>",
        sources: [{ link: "https://www.gg.ca/en/governor-general/governor-general-mary-may-simon/biography", name: "Biography&ThinSpace;&ndash;&ThinSpace;The Governor General of Canada, Her Excellency the Right Honourable Mary May Simon" }]
      },
      10: {
      ...
      13: {
        ...
        death: "1995",
        hideDates: false,
        imgSrc: "keena_beljaars",
        tags: ["art"],
        group: ["first"],
        content: "<p>Keena Beljaars was born to a Mohawk father and French-Canadian mother in 1949. She was given up to be adopted and, until she was a young teenager, grew up in an orphanage. She was taken in as a foster child to a strict French-Canadian home. She always knew she was native although she had never been told this. Keena said she was from the bear tribe. She began working with red clay when she was in her twenties and this small beginning translated into creating a world of colourful figurines in different tribal costumes. A favorite theme of hers was mother and child and she eventually had three children herself. She often incorporated this into her bigger sculptures with other creatures like the wolf, the eagle, the bear and the turtle. She hand-sculpted vases and decorated them with ceramic paints and she created a multitude of multi-faceted masks to ward off evil. In 2005, one of her Nativity scenes was used on a Canadian 85 cent stamp and another of her Nativity scenes is being displayed at St. Joseph’s Oratory.</p>",
        sources: [{ link: "https://montrealserai.com/article/keena-native-indian-artist/", name: "Keena&ThinSpace;&ndash;&ThinSpace;Native Indian Artist&ThinSpace;&ndash;&ThinSpace;Montreal Serai" }]
      },
      14: {
        name: "Lee Maracle, <abbr title=\"Order of Canada\">OC</abbr>",
        birth: "1950",
        death: "",
        hideDates: false,
        imgSrc: "lee_maracle",
        tags: ["art"],
        group: ["first"],
        content: "<p>Lee Maracle, of Salish and Cree ancestry and member of the Stó:lō Nation, was born in Vancouver, <abbr title=\"British Columbia\">B.C.</abbr>, in 1950. She is a poet and author, as well as the mother of four and grandmother of four. She speaks out as a critic of the treatment of Indigenous people by the Canadian state, and she particularly highlights the issues relating to Indigenous women. The granddaughter of Tsleil-Waututh Chief Dan George, Maracle grew up in the neighbouring city of North Vancouver as one of the first Indigenous children to be allowed to attend a normal state (public) school. She dropped out of school and went to California where she did various jobs that included producing films and doing stand-up comedy. She returned to Canada and attended Simon Fraser University. She was one of the first Aboriginal people to be published in the early 1970s.</p><p>Maracle is one of the most prolific Indigenous authors in Canada and a recognized authority on issues pertaining to Indigenous people and Indigenous literature. She is a poet, novelist, performance storyteller, scriptwriter, actor and keeper/mythmaker among the Stó:lō people. Maracle was one of the founders of the En'owkin International School of Writing in Penticton, British Columbia and the cultural director of the Centre for Indigenous Theatre in Toronto, Ontario. Maracle has given hundreds of speeches on political, historical, and feminist sociological topics related to Indigenous people, and conducted dozens of workshops on personal and cultural reclamation. She has served as a consultant on First Nations' self-government and has an extensive history in community development. She has been described as &ldquo;a walking history book&rdquo; and an international expert on Canadian First Nations culture and history. Her views (as broadcast 18 May 2014 on <abbr title=\"Canadian Broadcasting Corporation\">CBC</abbr> Radio) are that the Canadian people (not the government, because Canada is an &ldquo;illegitimate state&rdquo;) should accept responsibility for cultural genocide and the theft of the whole land from the Indigenous people. Maracle has taught at the University of Toronto, University of Waterloo, Southern Oregon University and has served as professor of Canadian culture at Western Washington University. She currently lives in Toronto, teaching at the University of Toronto First Nations House. She was the writer-in-residence at the University of Guelph. In 2017, Maracle was presented the Bonham Centre Award from The Mark S. Bonham Centre for Sexual Diversity Studies, University of Toronto, for her contributions to the advancement and education of issues around sexual identification. Most recently, Maracle was appointed officer to the Order of Canada (2018) for her contributions to Canada's literary landscape. Her newest poetry book, Hope Matters, was written in conjunction with her daughters Columpa Bobb and Tania Carter, and was published in 2019.</p>",
        sources: [{ link: "https://www.canadianscholars.ca/authors/lee-maracle", name: "Lee Maracle&ThinSpace;&ndash;&ThinSpace;Canadian Scholars" }, { link: "https://en.wikipedia.org/wiki/Lee_Maracle", name: "Lee Maracle&ThinSpace;&ndash;&ThinSpace;Wikipedia" }, { link: "https://www.strongnations.com/gs/show.php?gs=3&gsd=1065", name: "Lee Maracle&ThinSpace;&ndash;&ThinSpace;Strong Nations" }]
      },
      15: {
      ...
      19: {
        ...
        birth: "1951",
        death: "1997",
        imgSrc: "monique_sioui",
        tags: ["politics"],
        group: ["first"],
        content: "<p>Monique Sioui, born in Wendake, Quebec, on April 7, 195, grew up in Odanak and died in Val d'Or, on October 18, 1997. Monique Sioui was an activist for the rights of indigenous women and children. She was the sister of the artist Christine Sioui-Wawanoloath, the aunt of the former <abbr title=\"Parti Québécois\" lang=\"fr\">PQ</abbr> member Alexis Wawanoloath and a relative of the former news reader and radio and television host Jean-Paul Nolet. This activist was Wendate through her father and Abénakise through her mother. Monique Sioui is one of the founders of the Association of Native Women of Quebec and was its president in 1976. Under her mandate, a tour and two inquiries were initiated in Quebec. The first investigation dealt with discriminatory sections of the Indian Act. Among other things, it recommended that Aboriginal women no longer lose their status when they marry a non-Indian. In 1980, she traveled to the Netherlands for the 4<sup>th</sup> Russell Tribunal meeting where she denounced the discriminatory aspect of the Indian Act. Subsequently, she continued her battle against conjugal, family and sexual violence, particularly in the Algonquin community of Kitcisakik in Abitibi. To underline her great contribution to the well-being of Aboriginal communities, in 1998 she was posthumously awarded the Rights and Freedoms Award from the <span lang=\"fr\">Commission des droits de la personne et des droits de la jeunesse</span>.</p>",
        sources: [{ link: "https://fr.wikipedia.org/wiki/Monique_Sioui", name: "<span lang=\"fr\">Monique Sioui&ThinSpace;&ndash;&ThinSpace;Wikipédia</span>" }]
      },
      20: {
      ...
      21: {
        name: "Christine Sioui-Wawanoloath",
        birth: "1952",
        death: "",
        hideDates: false,
        imgSrc: "christine_sioui_wawanoloath",
        tags: ["art"],
        group: ["first"],
        content: "<p>Abenaki and Wendat, Christine Sioui Wawanoloath was born in 1952 in Wendake, her father's community. When her father died, a few weeks after her birth, her mother returned to her family in Odanak with her three children. Sioui Wawanoloath spent her childhood there in a family of craftsmen where creation and the arts were omnipresent. Later, she attended the famous Manitou College, the first Native college in Quebec. She studied arts, photography and history there, which she continued in Montreal. For four decades, she devoted herself to her illustration work with remarkable consistency, making images for various publications, various Indigenous events and campaigns of all kinds. As a visual artist, she participates in numerous exhibitions. She is also an author of children's stories and plays. Among his publications are Natanis (<span lang=\"fr\">Le Loup de Gouttière</span>, 2005), <span lang=\"fr\">L'ours et la femme venus des étoiles</span> (Cornac, 2009), Nanibôssad ôtloka&nbsp;/ <span lang=\"fr\">La lune tells</span>&nbsp;/ Moon's Tales (Éditions Hannenorak, 2011) and Noki (Éditions Hannenorak , 2017). Her tale <span lang=\"fr\">Le clan des oiseaux</span> was adapted on stage by the <span lang=\"fr\">Orchestre symphonique de Québec</span> as part of the Quebec City 400<sup>th</sup> anniversary celebrations. Greatly inspired by Wendat and Abenaki legends, but also by all the mythological baggage of humanity, her works are carriers of light and magic. From 2002 to 2008, Ms. Sioui-Wawanoloath was a communications agent for &ldquo;Land in Views&rdquo;. She now lives in Odanak where she devotes herself full time to her art.</p>",
        sources: [{ link: "https://fr.wikipedia.org/wiki/Christine_Sioui-Wawanoloath", name: "<span lang=\"fr\">Christine Sioui-Wawanoloath&ThinSpace;&ndash;&ThinSpace;Wikipédia</span>" }, { link: "https://kwahiatonhk.com/auteurs/christine-sioui-wawanoloath/", name: "<span lang=\"fr\">Christine Sioui-Wawanoloath&ThinSpace;&ndash;&ThinSpace;Kwahiatonhk!</span>" }]
      },
      22: {
        ...
        sources: [{ link: "https://en.wikipedia.org/wiki/Shirley_Cheechoo", name: "Shirley Cheechoo&ThinSpace;&ndash;&ThinSpace;Wikipedia" }, { link: "https://www.weengushk.com/whatiswfi", name: "Our Mission&ThinSpace;&ndash;&ThinSpace;Weengushk Film institute" }]
      },
      23: {
      ...
      26: {
        name: "Michèle Rouleau",
        birth: "1956",
        death: "",
        imgSrc: "michele_rouleau",
        tags: ["education"],
        group: ["metis"],
        content: "<p>Born in Senneterre, Abitibi, on August 20, 1956, Métis of Ojibway mother and Quebec father, Michèle Rouleau was greatly involved in the issue of family violence and in claims for the protection of the right to equality of indigenous women. She was president of the Native Women's Association of Quebec from 1987 to 1992. First executive director of the Native Friendship Center of Senneterre from 1978 to 1980, then regional coordinator of the employment of Native women at the Commission of Canadian Employment and Immigration, she was also Provincial Secretary of the Native Women's Association in 1986-1987. Ms. Rouleau has served on several boards of directors, including: the Native Women's Association of Canada, the Montreal Native Women's Shelter and the Quebec Federation of Women. She is a member of the Native Friendship Center of Montreal and the League of Rights and Freedoms.</p><p>Let us mention her publications: the editorial of the journal <span lang=\"fr\">Rencontre du Secrétariat aux affaires autochtones du Québec</span>, June 1991; Anisnabe kwe: The awakening of Indian women, <span lang=\"fr\">Vie Ouvrière</span>, Sept.-Oct. 1987; Co-author of <span lang=\"fr\">Vitalités et regroupement chez les femmes autochtones du Québec</span> on behalf of the Secretary of State (1982). She was also a research consultant for the production of the film The future in our hands (<abbr title=\"Office national du film\" lang=\"fr\">ONF</abbr>) and the host of Nations, on <span lang=\"fr\">Télé-Québec</span> and <abbr title=\"Réseau de l'information\" lang=\"fr\">RDI</abbr>, a program on Aboriginal realities. Finally, she hosted and produced the documentary series Mishkuenita, broadcast on the <abbr title=\"Aboriginal Peoples Television Network\">APTN</abbr> network. Michèle Rouleau founded Wabanok Productions and is its executive producer.</p><p>She has given several lectures on indigenous issues, among others, at the Estates General of Human Rights (Paris, 1989). She also chaired the White Justice / Indigenous Justice conference of the Intercultural Institute of Montreal in May 1991. Ms. Rouleau received the Justice Prize from the Government of Quebec in 1992, she also received the Rights and Freedoms Prize from the <span lang=\"fr\">Commission des droits de la personne du Québec</span>.</p>",
        sources: [{ link: "https://fr.wikipedia.org/wiki/Mich%C3%A8le_Rouleau", name: "<span lang=\"fr\">Michèle Rouleau&ThinSpace;&ndash;&ThinSpace;Wikipédia</span>" }, { link: "https://www.ordre-national.gouv.qc.ca/membres/membre-en.asp?id=315", name: "<span lang=\"fr\">Michèle Rouleau, Chevalière (1993)&ThinSpace;&ndash;&ThinSpace;Ordre national du Québec</span>" }]
      },
      27: {
        name: "Michelle Good",
        birth: "1956",
      ...
      30: {
        ...
        tags: ["education"],
        group: ["first"],
        content: "<p><abbr title=\"doctor\">Dr.</abbr> Winona Wheeler is a member of the Fisher River Cree Nation in Treaty 5 territory and has family roots in Gorge Gordon First Nation, Treaty 4 territory. A lifelong student of Indigenous knowledge, oral history, anti-colonial theory and critical Indigenous Studies, Winona has been teaching and publishing in Indigenous Studies since 1988. In addition to her faculty appointments in Indigenous Studies at First Nations University of Canada (<abbr>FNUniv</abbr>), Athabasca University (<abbr>AU</abbr>) and the University of Saskatchewan (<abbr>Usask</abbr>) she also served as Campus Dean (<abbr title=\"First Nations University of Canada\">FNUniv</abbr>) and Department Head (<abbr title=\"First Nations University of Canada\">FNUniv</abbr> and <abbr title=\"University of Saskatchewan\">Usask</abbr>). Winona is a strong promoter of Indigenous research methodologies, oral history, community-engaged and social action research. Over the years she has developed, led, and collaborated on numerous historical research projects with Indigenous communities and organizations including, among others, specific land claims, the Manitoba Treaties Oral History Project, and as an expert witness on Indigenous oral histories in The Victor Buffalo Case Federal Court case. </p><p>Dr. Wheeler earned her <abbr title=\"Philosophi&aelig; doctor\">PhD</abbr> in Comparative Ethnic/Native American Studies in 2000 (University of California, Berkeley), an <abbr title=\"Master of Arts\">MA</abbr> in History in 1988 (University of British Columbia), and a <abbr title=\"Bachelor of Arts\">BA</abbr> Honors in history in 1986 (University of Manitoba). She is of Cree/Assiniboine/Saulteaux/Irish/English heritage and lives on a little ranch with her horses, dogs and old porch cat.</p>",
      ...
      31: {
        ...
        death: "",
        hideDates: false,
        imgSrc: "ellen_gabriel",
        tags: ["politics"],
        group: ["first"],
        content: "<p>Ellen Gabriel, also known as Katsi'tsakwas, is a Mohawk activist and artist from Kanehsatà:ke Nation&ThinSpace;&ndash;&ThinSpace;Turtle Clan, known for her involvement as the official spokesperson, chosen by the People of the Longhouse, during the Oka Crisis. In March 1990, she joined in the movement against the expansion of a golf course in Oka, Quebec. That event eventually escalated into the Oka Crisis. In order to raise awareness of the crisis, she traveled internationally, including visits to The Hague, Strasbourg and Japan. During this time, in May 1990, she received a Bachelor of Fine Arts from Concordia University. In 1993, the documentary Kanehsatake: 270 Years of Resistance was released; she was a prominent part of the film. The next decade after the crisis had been settled, she worked as an Illustrator/Curriculum developer for Tsi Ronteriwanónha ne Kanien’kéka/ Kanehsatà:ke Resource Center in Kanehsatà:ke and also worked as an Art Teacher for the Mohawk Immersion School for grades 1-6.</p><p>She has made numerous public presentations on Indigenous rights and history, to post-secondary institutions, conferences, including presentations to Parliamentary and Senate committees as well as, Québec's National Assembly on legislative amendments affecting the rights of Indigenous peoples in Canada. She has been active at the international level participating at the United Nations Permanent Forum on Indigenous issues, negotiations on the Nagoya Protocol of the Convention on Biodiversity and advocated for Indigenous languages and cultures at the <abbr title=\"United Nations\">UN</abbr> Expert Mechanism on the Rights of Indigenous Peoples.</p><p>She has traveled across Canada, to the Hague in Holland, Strasbourg, France to address the European parliament; and to Japan to educate people about the events in her community during the 1990 &ldquo;Oka Crisis&rdquo; or as it is locally known, the 1990 Siege of Kanehsatà:ke.</p><p>Ellen has also worked on videos illustrating legends of the Iroquois people and the local community stories. She is presently an active board member of Kontinón:stats&ThinSpace;&ndash;&ThinSpace;Mohawk Language Custodians Association and First Peoples Human Rights Coalition.</p><p>In 2004, Ellen Gabriel was elected president of the Quebec Native Women’s Association a position which she held for 6 ½ years, until December 2010. During this time she brought changes to the Indian Act in the form of Bill C-31.</p><p>She believes that decolonization will be achieved through the implementation of the United Nations Declaration on the Rights of Indigenous Peoples with the full and effective participation of Indigenous peoples. She believes that education controlled by First Nations peoples based upon our languages and culture are paramount to the revitalization of our institutions which have been consistently under attack by the Indian Act, the Indian Residential School and subsequent colonial legislation and policy. Ms. Gabriel believes that Indigenous peoples' traditional knowledge is precious, as it is the key corner stone for Indigenous peoples in overcoming colonial oppression and restoring the institutions and teachings of our ancestor. She is an advocate for gender equity, the revitalization of Indigenous languages, culture, traditions and Indigenous governing structures. Ms. Gabriel lives in Kanehsatà:ke and currently works for the Kanehsatà:ke Language and Cultural Center.</p><p>Awards: In 2005 Ms. Gabriel received the Golden Eagle Award from the Native Women’s Association of Canada; 2008 International Women’s Day Award from the <span lang=\"fr\">Barreau du Québec</span>/Québec Bar Association and as well in August 2008 Ms. Gabriel was the recipient of the Indigenous Women’s Initiative &ldquo;Jigonsaseh Women of Peace Award&rdquo; for her advocacy work.</p>",
        sources: [{ link: "http://www.newfederation.org/Native_Leaders/Bios/Gabriel.htm", name: "Ellen Gabriel, Katsi’tsakwas, Kanien’kehá:ka Nation (Mohawk), 1959-&ThinSpace;&ndash;&ThinSpace;Native Leaders of Canada" }, { link: "https://en.wikipedia.org/wiki/Ellen_Gabriel", name: "Ellen Gabriel&ThinSpace;&ndash;&ThinSpace;Wikipedia" }]
      }
    },
    d1960: {
      0: {
      ...
      6: {
        ...
        death: "",
        hideDates: false,
        imgSrc: "cindy_blackstock",
        tags: ["education"],
        group: ["first"],
        content: "<p>A member of the Gitxsan First Nation, Cindy is a Professor at the McGill School of Social Work and Executive Director of the First Nations Child and Family Caring Society. She has worked in Indigenous children’s rights for over 30 years and is honored to work with others to promote culturally based equity for First Nations children and their families using a combination of public education, engagement and, more recently, litigation. Although she is probably best known for her work on the Canadian Human Rights Tribunal’s landmark human rights ruling released in 2016 finding Canada’s failures to provide equitable First Nations child welfare services and implement Jordan’s Principle to be discriminatory, her true passion is working with children to implement the Truth and Reconciliation Commission’s Calls to Action.</p><p>Cindy is the author of over 60 publications and is a prolific public speaker. <abbr title=\"Doctor\">Dr.</abbr> Blackstock has collaborated with other Indigenous leaders to assist the United Nations Committee on the Rights of the Child in the development and adoption of a General Comment on the Rights of Indigenous children. Recently, she also worked with Indigenous young people, UNICEF &amp; the United Nations Permanent Forum on Indigenous Issues to produce a youth friendly version of the United Nations Declaration on the Rights of the Child. Her promotion of culturally based & evidence informed solutions has been recognized by the Nobel Women’s Initiative, the Aboriginal Achievement Foundation, Frontline Defenders and many others. As Cindy says, &ldquo;the law is not naturally just. Injustices like residential schools were lawful in their time. True justice only comes when the law is linked with love and compassion and that is what children, and their teddy bears, bring.&rdquo;</p>",
        sources: [{ link: "https://www.mcgill.ca/socialwork/about/people/faculty/cindy-blackstock", name: "Cindy Blackstock, Professor&ThinSpace;&ndash;&ThinSpace;McGill University" }, { link: "https://www.uottawa.ca/president/people/blackstock-cindy", name: "Cindy Blackstock&ThinSpace;&ndash;&ThinSpace;University of Ottawa" }]
      },
      7: {
      ...
      8: {
        ...
        tags: ["literature"],
        group: ["first"],
        content: "<p>Kateri Akiwenzie-Damm is an Anishinaabe writer of mixed ancestry from the Chippewas of Nawash Unceded First Nation, Saugeen Ojibway Nation. She lives and works at Neyaashiinigmiing, Cape Croker Reserve on the Saugeen Peninsula in southwestern Ontario, and in Ottawa, Ontario. A cultural worker with an activist bent, Kateri has initiated many important projects on behalf of Indigenous writers of Turtle Island (North America) and active collaborations with artists and publishers in New Zealand and Australia. A spoken word artist and literary performer as well as poet, writer, editor, publisher and Assistant Professor of Creative Writing, Indigenous Literatures and Oral Traditions at the University of Toronto, Scarborough, Ms. Akiwenzie-Damm works both behind the scenes and before live audiences. </p><p>In 1993, she established Kegedonce Press, one of very few literary publishing houses devoted to indigenous writers. It continues to produce anthologies and single author books of distinction. Acclaimed Canadian authors Basil H. Johnston (Ojibway), Marilyn Dumont (Métis) and Gregory Scofield (Métis) are among those who have published books through Kegedonce Press. She is both the founder and publisher of Kegedonce Press. Kateri has written two books of poetry and the graphic novel Nimkii which was published in the bestselling anthology This Place: 150 Years Retold was editor of the award-winning Skins: Contemporary Indigenous Writing, and has also released two poetry and music <abbr>CD</abbr>s, including A Constellation of Bones which was nominated for an Indigenous Music Award. Her short story collection, The Stone Collection, received a coveted starred review by Publishers Weekly and was nominated for a Sarton Literary Book Award. Kateri’s work has been published internationally, and she has performed and spoken around the world. She is a nominee for the prestigious 2021 Ontario Arts Council Indigenous Arts.</p>",
        sources: [{ link: "https://en.wikipedia.org/wiki/Kateri_Akiwenzie-Damm", name: "Kateri Akiwenzie-Damm&ThinSpace;&ndash;&ThinSpace;Wikipedia" }, { link: "https://www.portageandmainpress.com/Contributors/A/Akiwenzie-Damm-Kateri", name: "Kateri Akiwenzie-Damm&ThinSpace;&ndash;&ThinSpace;Portage &amp; Main Press" }]
      },
      9: {
        name: "Edith Cloutier",
        birth: "1966",
        death: "",
        hideDates: false,
        imgSrc: "edith_cloutier",
        tags: ["education"],
        group: ["first"],
        content: "<p>Born in the town of <span lang=\"fr\">Ville-Marie</span> on Lake Temiskaming in western Quebec in 1966, Cloutier was hired at the age of fifteen to wash dishes at the <span lang=\"fr\">Val-d’Or</span> Native Friendship Centre as part of a summer student program. She became keenly aware that this centre, and others like it, were critical gathering places where First Nations, Métis, and Inuit people could feel both proud and connected, and where they could access culturally relevant and safe programs and services. Eight years later&ThinSpace;&ndash;&ThinSpace;after acquiring a degree in accounting science at the <span lang=\"fr\">Université du Québec en Abitibi-Témiscamingue</span>&ThinSpace;&ndash;&ThinSpace;Cloutier became the Friendship Centre’s Executive Director at just twenty-three years of age. Later, she became head of <span lang=\"fr\">Le Regroupement des centres d’amitié autochtones du Québec</span>, which is part of the Friendship Centre Movement, a network of 118 centres and the largest service infrastructure for urban Aboriginals in Canada.</p><p>In 2015, Cloutier played a key role in the events that led Aboriginal women living in <span lang=\"fr\">Val-d’Or</span> to file complaints against police officers of the <span lang=\"fr\">Sûreté du Québec</span> for sexual and physical abuse after an initial investigation by the <span lang=\"fr\">Radio-Canada</span> television program <span lang=\"fr\">Enquête</span>. Significantly, these women gathered at the <span lang=\"fr\">Val-d’Or</span> Native Friendship Centre. &ldquo;This is where the women found cultural safety to speak out,&rdquo; says Cloutier. &ldquo;Together, they felt they had the strength to bring it out in the open.&rdquo; Édith Cloutier takes the position that the case in <span lang=\"fr\">Val-d’Or</span>, set against the context of the broader issue of missing and murdered Aboriginal women across the country, points to systemic racism. To not act, she argues, is to be complicit.</p>",
        sources: [{ link: "https://www.gg.ca/en/node/137", name: "Édith Cloutier, C.M., Member of the Order of Canada&ThinSpace;&ndash;&ThinSpace;2013&ThinSpace;&ndash;&ThinSpace;The Governor General of Canada" }]
      },
      10: {
        name: "Rita Mestokosho",
        birth: "1966",
        death: "",
        hideDates: false,
        imgSrc: "rita_mestokosho",
        tags: ["art"],
        group: ["first"],
        content: "<p>Rita Mestokosho is an Innu poet, writer and activist. She was born in 1966 in Ekuanitshit, Quebec, and still lives there. Rita Mestokosho spent a good part of her childhood spending time in the forest with her parents. She attended the University of Quebec at Chicoutimi in political science. After her studies, she returned to her home village to work in the field of education and then, at the request of the women of the village, she became a councilor for the Innu Council of Ekuanitshit. Rita Mestokosho is a mother of two, so she understands the impact working with young people can have in the world. Her work in education and at the Innu Council of Ekuanitshit shows her willingness to participate in the functioning of the Innu community and in the organization of cultural and educational projects. She is one of the first native poets published in Quebec. Her contributions have also been recognized worldwide and Rita Mestokosho has participated in various events around the world, including in Italy and Venezuela. It is quoted in the speech of J.M.G. <span lang=\"fr\">Le Clézio</span> prior to his Nobel Prize. In 2014, she published another book of poetry, Born of the rain and the earth. Mestokosho's works reflect not only her Innu identity, but also Francophone culture. For example, Eshi Uapataman Nukum consists of eight bilingual poems, written in Innu and French, and twelve texts written in French only. Mestokosho combined her poetry with the photography of Patricia Lefebvre to show how Innu culture and Quebec culture can coexist.</p><p>Rita Mestokosho is not only a poet, but also an Innu activist. She participated in the creation of the Maison de la culture Innu where she works as a coordinator and fights for the recognition of the Innu language. She is also a member of the local Innu council and is the spokesperson for the Innu community. Mestokosho also fought against the construction of a hydroelectric dam on the Romaine River. She campaigns for the preservation of her land, her language, and her culture. She makes many references to freedom in her poetry, illustrating the fact that Innu communities are often neglected and unrecognized. In her lectures, she generally speaks first in Innu, to make her native language heard, then in French.</p>",
        sources: []
      },
      11: {
        name: "Leona Aglukkaq",
      ...
      14: {
        ...
        group: ["first"],
        content: "<p>Lea Nicholas-MacKenzie is a consultant specializing in Indigenous issues. She is the founder of <abbr>LNM</abbr> Indigenous Consulting, a boutique consulting company working with Indigenous Peoples, governments, organizations and corporations to achieve transformative change. She is a member of the Wəlastəkwey nation (Maliseet First Nation) at Negwotkok (Tobique), in New Brunswick. She holds a <abbr title=\"Bachelor of Arts\">BA</abbr> in French Language and Linguistics from the University of New Brunswick and an <abbr title=\"Master of Arts\">MA</abbr> in Leadership and Training from Royal Roads University. Lea is an accomplished facilitator and public speaker, with extensive experience in project management, policy development, international relations and communications.</p><p>Lea has held a number of senior roles within Indigenous organizations as well as in the federal government. She recently completed an appointment as the Special Adviser for Indigenous Issues, based at the Permanent Mission of Canada to the United Nations in New York.</p><p>Previously, Lea served as Chief of Staff to the Minister of Justice and Attorney General of Canada as well as Director of Political Operations. Lea also served as Campaign Manager for the Honourable Jody Wilson-Raybould. She was the Chief Operating Officer of Tewanee Consulting Group, focused on meaningful Indigenous partnerships, communications strategies, project management and strategic planning. As the Chief of Protocol and Director of Aboriginal Outreach and Participation for the Four Host First Nations during the Vancouver 2010 Olympic and Paralympic Winter Games, as well as Acting Director of Aboriginal Participation for the Vancouver Organizing Committee for the 2010 Winter Games (<abbr>VANOC</abbr>), she worked with a team that delivered unprecedented Indigenous participation, with major involvement in such elements as the Torch Relays; ceremonies; licensing and merchandizing; protocol; accreditation and ticketing; and the Vancouver 2010 Indigenous Youth Gathering. Other senior positions include: Chief of Staff to the National Chief, and Senior Policy Advisor, International Policy and Relations at the Assembly of First Nations, and policy advisor to the Deputy Minister and Associate Deputy Minister at the Department of Indian Affairs and Northern Development. As a consultant, Lea provided assistance to First Nations, Indigenous organizations and the federal government on a broad range of activities and initiatives, including preparing research papers, feasibility studies, needs assessments, business plans, management plans and funding strategies.</p><p>Lea has extensive experience in international policy and relations, formerly serving on:</p><ul><li>International committees active at the United Nations, particularly focused on Indigenous women and the United Nations Declaration on the Rights of Indigenous Peoples;</li><li>The Coordinating Committee for the First Indigenous Women’s Summit of the Americas;</li><li>The Indigenous Peoples Partnership Program Project Review Committee at the Canadian International Development Agency;</li><li>The organizing committees for the 2<sup>nd</sup> and 3<sup>rd</sup> Indigenous Peoples Summit of the Americas;</li><li>The Canadian Advisory Group on Indonesia;</li><li>As the Global Coordinator/North American Representative on the Steering Committee of the International Indigenous Women’s Forum;</li><li>As treasurer of the International Indigenous Women’s Fund; and</li><li>As a member of the President’s Advisory Committee on Aboriginal Affairs at the University of British Columbia.</li></ul></p><p>Lea is also a trained French Chef, holding a Grand Diploma in Culinary Arts and Pastry from <span lang=\"fr\">Le Cordon Bleu</span>. She has worked in small boutique restaurants, as a private chef, and as <span lang=\"fr\">Sous Chef</span> and Pastry Chef at 24 Sussex, the residence of the Prime Minister of Canada.</p>",
      ...
      19: {
        ...
        death: "",
        hideDates: false,
        imgSrc: "michele_audette",
        tags: ["politics"],
        group: ["first"],
        content: "<p>Michèle Taïna Audette is a Canadian politician and Native Canadian activist. She grew up in Schefferville, Maliotenam, and Montreal. Her mother, Evelyne St-Onge, is Innu and her father, Gilles Audette, is French-Canadian from Montreal. The family was denied a house on her mother's reserve under federal law because her mother married a non-Native man. St-Onge was a co-founder of Quebec Native Women (<abbr>FAQ</abbr>), which fought against the clause in the federal Indian Act that stated that a Native woman who marries a non-Native man did not have the right to live in her reserve community. As Audette grew up, she too became an activist in indigenous affairs. She has served as president of <span lang=\"fr\">Femmes autochtones du Québec</span> (Quebec Native Women) and the Native Women's Association of Canada. She served from 2004 through 2008 as Associate Deputy Minister at the Ministry of Relations with Citizens and Immigration of the Quebec government, where she was in charge of the Secretariat for Women. In 2017, she was appointed as one of the five commissioners of the government's national inquiry into missing and murdered Indigenous women and girls. She has also worked as a researcher for Aboriginal Nations, a news magazine broadcast on <span lang=\"fr\">Télé-Québec</span>. In May 2021 she appeared on <span lang=\"fr\">Ici Radio-Canada</span>'s literary debate show <span lang=\"fr\">Le Combat des livres</span>, advocating for Michel Jean's novel Kukum. The novel won the competition. Some years after her first government service, Audette decided to enter electoral politics. In the 2015 Canadian federal election, she ran as the Liberal candidate for the Quebec riding of Terrebonne but was not elected. Audette, a mother of five, lives in both Wendake near Québec City and the Innu reserve of Maliotenam near Sept-Îles, Quebec, with her domestic partner Serge Ashini Goupil. He is a consultant with the indigenous rights group <span lang=\"fr\">Nation Innue</span>.</p>",
        sources: [{ link: "https://en.wikipedia.org/wiki/Mich%C3%A8le_Audette", name: "Michèle Audette&ThinSpace;&ndash;&ThinSpace;Wikipedia" }]
      },
      20: {
        name: "Nadia Myre",
        birth: "1974",
        ...
        tags: ["art"],
        group: ["first"],
        content: "<p>Nadia Myre is an indigenous and quebecois artist from Montreal who is interested in having conversations about identity, resilience and politics of belonging. A graduate from Camosun College (1995), Emily Carr (1997), and Concordia University (<abbr title=\"Master of Fine Arts\">M.F.A.</abbr>, 2002), Myre is a recipient of numerous awards, notably <span lang=\"fr\">Compagne des arts et des lettres du Québec</span> (2019), Banff Centre for Arts Walter Phillips Gallery Indigenous Commission Award (2016), Sobey Art Award (2014), Pratt & Whitney Canada’s &ldquo;<span lang=\"fr\">Les Elles de l’art</span>&rdquo; for the <span lang=\"fr\">Conseil des arts de Montréal</span> (2011), Quebec Arts Council’s <span lang=\"fr\">Prix à la création artistique pour la region des Laurentides</span> (2009), and a Fellowship from the Eiteljorg Museum (2003). Recent accomplishments include Balancing Acts (Textile Museum of Canada, 2019), Code Switching and Other New Work (Glasgow International, 2018), <span lang=\"fr\">Tout ce qui reste</span> / Scattered Remains (Montreal Museum of Fine Art, 2017), Decolonial Gestures or Doing it Wrong? <span lang=\"fr\">Refaire le chemin</span> (McCord Museum, 2016) and commissions for new work: <span lang=\"fr\">Dans l’attente&hellip;</span> | While Waiting&hellip; (<span lang=\"fr\">Ville de Montreal</span>, 2019), Oceanus Procelleum (Zuecca Project &ldquo;Volume 0&rdquo;, Venice Biennale, 2019), Tree of Shifting Forms (Canadian Embassy in Paris, 2018), the Quebec Room carpet design (2015) for Canada House in London, England (with Karen Spencer), Orison (galerie Oboro, 2014), <span lang=\"fr\">Formes et Paroles</span> (Musée Dapper, Senegal, 2014), and Sakahàn (National Gallery of Canada, 2013). As well as having participated in international biennales (Glasgow 2018, Shanghai 2014, Sydney 2012, and Montreal 2011), Myre’s work has featured in prominent group exhibitions such as Changing Hands 3 (Museum of Art and Design, New York, <abbr title=\"New York\">NY</span>), <span lang=\"fr\">Pour une république des rêves</span> (<span lang=\"fr\">CRAC Alsace - Centre Rhénan d’Art Contemporain</span>, Altkirch, <abbr title=\"France\">FR</abbr>), <span lang=\"fr\">Le temp du dessin</span> (<span lang=\"fr\">Ensemble Poirel</span>, Nancy, France), Vantage Point (National Museum of American Indian National Mall, Washington, <abbr title=\"District of Columbia\">DC</abbr>), It Is What It Is (National Gallery of Canada), and <span lang=\"fr\">Femmes Artistes</span>. <span lang=\"fr\">L’éclatement des frontières</span> 1965-2000 (<span lang=\"fr\">Musée national des beaux-arts du Québec</span>, <abbr title=\"Quebec\">QC</abbr>). Her work has received accolades from the New York Times, The Washington Post, and <span lang=\"fr\">Le Devoir</span>, and has been featured in ARTnews, Canadian Art, Parachute, American Craft, C Magazine, and Monopol. Her works may be found on permanent exhibition at the Montreal Museum of Fine Arts, National Gallery of Canada, <span lang=\"fr\">Musée National des Beaux-Arts du Québec</span>, Canadian Museum of History, and the <span lang=\"fr\">Musée des civilization</span> (Quebec).</p>",
        sources: [{ link: "http://www.nadiamyre.net/about-a-propos", name: "About Nadia&ThinSpace;&ndash;&ThinSpace;Nadia Myre" }]
      },
      21: {
        name: "Isabelle Picard",
        birth: "1975",
        death: "",
        hideDates: false,
        imgSrc: "isabelle_picard",
        tags: ["media"],
        group: ["first"],
        content: "<p>Isabelle Picard holds a bachelor's degree in ethnology&nbsp;/ anthropology with a minor in native studies as well as a graduate diploma in museology, obtained at Laval University. For twenty years, Ms. Picard, herself Huron-Wendat, has been trying through her various professional and personal actions to raise awareness of the realities of the First Nations as well as the associated issues. Consultant for a decade with indigenous and non-indigenous organizations in the fields of culture, health, education, philanthropy, politics or other, she constantly tries to make a difference for more harmonious relations between Aboriginals and non-Aboriginals. Since the spring of 2016, she has been special advisor to the independent observer appointed in the case of indigenous women in <span lang=\"fr\">Val-d´Or</span>. She has also been a lecturer at St-Paul University and <abbr title=\"Université du Québec à Montréal\" lang=\"fr\">UQAM</abbr>.</p><p><span lang=\"fr\">Radio-Canada</span> appoints Isabelle Picard as Senior Specialist in Indigenous Affairs. She has served as a consultant to nearly two dozen government and Indigenous entities, including the Assembly of First Nations Quebec-Labrador and the Quebec department of public security. She also sits on the board of the <span lang=\"fr\">Musée de la civilisation de Québec</span>, lectures at <abbr title=\"Université du Québec à Montréal\" lang=\"fr\">UQAM</abbr>, and is a regular contributor to <span lang=\"fr\">Radio-Canada</span>’s <span lang=\"fr\">Espaces autochtones</span> and the <span lang=\"fr\">Télé-Québec</span> series Kebec. Until recently, she was a contributor to <span lang=\"fr\">La Presse+</span>.</p>",
        sources: [{ link: "https://www.mcq.org/documents/10706/669572/bio_isabelle_picard.pdf", name: "<span lang=\"fr\">Isabelle Picard&ThinSpace;&ndash;&ThinSpace;Musée de la civilisation de Québec</span>" }, { link: "https://cbc.radio-canada.ca/en/media-centre/appointment-isabelle-picard", name: "<span lang=\"fr\">Radio-Canada</span> appoints Isabelle Picard as Senior Specialist in Indigenous Affairs&ThinSpace;&ndash;&ThinSpace;CBC/<span lang=\"fr\">Radio-Canada</span>" }]
      },
      22: {
        name: "Tanya Tagaq",
        birth: "1975",
      ...
      23: {
        name: "Taqralik Partridge",
        birth: "1975",
        death: "",
        hideDates: false,
        imgSrc: "taqralik_partridge",
        tags: ["art"],
        group: ["inuit"],
        content: "<p>Poet, performer, throat-singer and curator born in Montréal (Québec) in 1975. Taqralik Partridge was born in 1975 in Montréal, to an Inuk father and a Scottish mother. She has fond childhood memories of several Arctic villages and has selected Kuujjuaq as her home. Taqralik returned to Montréal to study and stayed to work for the Avataq Cultural Institute, as its director of communications in the 2000s until launching full-time into an artistic career.</p><p>Taqralik Partridge’s performance art focuses on poetry describing Inuit life experiences in northern and southern Québec. She is a spoken word poet, performing live and incorporating throat-singing into her performances and YouTube recordings. In 2008, when conductor Kent Nagano and members of the Montréal Symphony Orchestra toured three Nunavik communities for the first time, she was on stage throat-singing with Evie Mark, a musician and teacher from Nunavik. The same year, she co founded Montréal’s Tusarniq, a festival of words, music and images showcasing indigenous artists. Taqralik was a featured artist onstage at the 2010 Olympics in Vancouver, British Columbia and narrator for the 2015 audiobook edition of Minnie Aodla Freeman’s Life Among the Qallunaat (1978).</p><p>Taqralik Partridge’s writing has appeared in several magazines, Inuktitut, Makivik Magazine, Makivik News, Inuit Art Quarterly and Maisonneuve, where her short story Igloolik won first prize in the 2010 Quebec Writing Competition. In 2014, she was invited to be the guest editor of Canada’s prestigious literary magazine Arc Poetry Magazine. A former member of the Inuit Art Quarterly’s editorial advisory council, she was selected Editor-at-Large in 2019, the first Inuk to be hired in this position. In 2020, her collection of poetry curved against the hull of a peterhead was launched at the ArtsEverywhere festival in Guelph, Ontario.</p><p>Another Inuk first, in 2018, was her co-curation of an Inuit artists’ exhibition at the Art Gallery of Ontario in Toronto called Tunirrusiangit, meaning &ldquo;the gifts they gave us&rdquo;. Her visual art was part of the exhibition, Among All These Tundras at the Leonard & Bina Ellen Art Gallery at Concordia University in Montréal in 2019. She was selected to be part of the Sydney Biennale (Australia) in 2020 and curated Qautamaat | Every day / everyday, a photography exhibition at the Art Gallery of Guelph, also in 2020. Taqralik Partridge will become the director of SAW Centre’s Nordic Lab: SAW, which was founded in 1973, is an artist-run centre focusing on performance and media arts, which is based in Ottawa. Taqralik Partridge will be heading the Nordic Lab as a new cultural centre in Ottawa, founded in partnership with the Canada Council for the Arts, promoting collaboration and exchange between Indigenous and non-Indigenous artists when it opens in 2020. Taqralik Partridge now lives in Canada and Kautokeino, Norway, in Northern Sápmi.</p>",
        sources: [{ link: "https://inuit.uqam.ca/en/person/partridge-taqralik", name: "Partridge, Taqralik&ThinSpace;&ndash;&ThinSpace;Inuit Literatures, <abbr title=\"Université du Québec à Montréal\" lang=\"fr\">UQAM</abbr>" }]
      },
      24: {
        ...
        tags: ["sports"],
        group: ["first"],
        content: "<p>Horn-Miller, a Mohawk from Kahnawake, Quebec, was born in 1975 and was the second youngest of four daughters. Her mother, Kahn-Tineta Horn, was a prominent Indigenous-right activist, and her father, George Miller, was an academic. Horn-Miller began swimming competitively at age seven and participated in meets from 1982 to 1997. To help her excel, Kahn-Tineta Horn, a single mother, moved the family to Ottawa, Ontario, across from a <abbr title=\"Young Men's Christian Association\">YMCA</abbr>, where her daughter could swim regularly. Horn-Miller became the provincial champion for her age group in 1989. Horn-Miller, was co-captain of Canada’s first Olympic women’s water polo team and a gold medallist in water polo at the 1999 Pan American Games. She is a well-known activist for Indigenous rights and a prominent role model, mentor and advocate for youth involvement in sports. The Canadian Association for the Advancement of Women and Sport and Physical Activity named her one of the country’s most influential women in sport in 2015.</p><p>Horn-Miller first received national media attention during the Oka Crisis in 1990. On 11 July 1990, Mohawk protesters clashed with Quebec provincial police over disputed land in Oka, Quebec. The town had decided to build condominiums and expand a golf course into a forest and burial land that the Mohawk considered sacred. A group of militants from the Kanesatake reserve, known as the Mohawk Warriors, set up a barrier to block a road that led to the golf course and ignored a court injunction to stand down. The conflict, known as the Oka Crisis, continued for 78 days and received international attention. While her mother served as a negotiator, Horn-Miller spent three tense weeks behind the barrier. At age 14, she cooked the midnight meals and breakfasts and took them to the Warriors. After a botched police raid and shootout resulted in the death of a corporal, the army erected barbed wire around the Mohawk encampment. Militants took refuge in a residential treatment centre for drugs and alcohol in Kanesatake. On 26 September, after a standoff was negotiated, Horn-Miller left the centre, carrying her four-year-old sister, Kaniehtiio. In the middle of a raucous crowd, she was stabbed close to the heart by a soldier’s bayonet and narrowly survived. (Horn-Miller later launched a human rights complaint, but it proved unsuccessful because she could not identify the soldier.) Although she considered quitting sports, her resilience and perseverance won out.</p>",
      ...
      28: {
        ...
        tags: ["education"],
        group: ["first"],
        content: "<p>Miranda Huron works in Indigenous education with a specialization in policy and language revitalization. She is currently the Director of Indigenous Education and Affairs at Capilano University, and is completing her <abbr title=\"Philosophi&aelig; doctor\">PhD</abbr> in Education at the University of British Columbia, with a focus on policy co-development and the Indigenous Languages Act. Her <abbr title=\"Philosophi&aelig; doctor\">PhD</abbr> work stems from her experiences as the Director of Languages and Culture for the Assembly of First Nations (<abbr>AFN</abbr>). In 2019, she oversaw the successful passing of the Indigenous Languages Act. She also holds an MEd in Education Policy and a <abbr title=\"Bachelor of Arts\">BA</abbr> in Linguistics from <abbr title=\"University of British Columbia\">UBC</abbr>.</p><p>In the early 2000s, Miranda was working in language revitalization, and worked for the University of British Columbia in partnership with the Musqueam Indian Band to develop an early model of an Indigenous Language website. Through that, she was also active in petitioning Unicode to recognize characters used for Indigenous languages.</p><p>Miranda is Anishinaabe from the Mattawa North Bay Algonquins. Having moved all over Ontario as a child, Miranda kept on going around the globe, surfing in Australia, cycling 6,000&ThinSpace;km across Canada, 5,700&ThinSpace;km in Russia from Vladivostok to Novosibirsk, and 11,000&ThinSpace;km in Africa from Cairo to Cape Town.</p>",
        sources: [{ link: "https://vancouversun.com/news/local-news/capilano-university-hires-its-first-director-of-indigenous-education-and-affairs", name: "Capilano University hires its first director of Indigenous education and affairs&ThinSpace;&ndash;&ThinSpace;Vancouver Sun" }, { link: "https://www.alumni.ubc.ca/about/board/miranda-huron-ba02-med16/", name: "Miranda Huron, BA’02, MEd’16&ThinSpace;&ndash;&ThinSpace;Alumni <abbr title=\"University of British Columbia\">UBC</abbr>" }]
      }
    },
    d1980: {
      0: {
        ...
        tags: ["art"],
        group: ["first"],
        content: "<p>Adéline Mark comes from Unamen Shipu, an Innu community on the Lower North Shore, with no road access that would link it to the rest of the province of Quebec. Like many others, she lived through residential schools and saw social problems multiply in her community. Adéline was raised by her grandparents before having to attend <span lang=\"fr\">Notre-Dame</span> boarding school in Maliotenam, near <span lang=\"fr\">Sept-Îles</span>. Philosophically, she says it was at residential school that she learned the difference between right and wrong. Faced with all the evil she says she saw at boarding school, Adéline felt helpless. But, over time, she managed to get over that feeling: &ldquo;We weren't able to defend ourselves. But today, I defend myself a lot&rdquo;. At 16, back at Unamen Shipu, Adéline Mark worked at the Hudson's Bay counter. She studied linguistics at <span lang=\"fr\">Université Laval</span> and worked as an Innu-French translator for filmmakers Arthur Lamothe and Pierre Perrault, as well as anthropologist Rémi Savard. This year, she contacted Wapikoni Mobile wishing to make a first film on traditional knowledge being passed down to the next generations. She has a passion for traditional Innu medicine, a subject she has thoroughly researched. She hopes to write a book on this subject. Today, Adéline must stay in <span lang=\"fr\">Sept-Îles</span> to receive medical treatment. She misses her community and long stays in the forest.</p>",
        sources: [{ link: "https://ici.radio-canada.ca/espaces-autochtones/1084907/adeline-mark-unamen-shipu", name: "<span lang=\"fr\">Adéline Mark&nbsp;: travailler pour le mieux-être des Innus&ThinSpace;&ndash;&ThinSpace;Radio-Canada Espaces Autochtones</span>" }, { link: "http://www.wapikoni.ca/filmmakers/adeline-mark", name: "Adéline Mark&ThinSpace;&ndash;&ThinSpace;Wapikoni Mobile" }]
      },
      1: {
      ...
      2: {
        name: "Eruoma Awashish",
        birth: "1980",
        death: "",
        hideDates: false,
        imgSrc: "eruoma_awashish",
        tags: ["art"],
        group: ["first"],
        content: "<p>Eruoma Awashish holds a Bachelor of Arts (interdisciplinary) from <span lang=\"fr\">Université du Québec à Chicoutimi</span>. She recently participated in the <span lang=\"fr\">Biennale d’art contemporain autochtone</span> &ldquo;Contemporary Native Art Biennial&rdquo; (<abbr>BACA</abbr>) and in the winter of 2017-2018, she presented an exhibition at the Montreal Fine Arts Museum. Her artistic approach aims to create spaces for dialogue and facilitate understanding of First Nations culture. She grew up in her home community of Opitciwan; she then resided in Wemotaci, but her studio is now based in Pekuakami (<span lang=\"fr\">Lac-St-Jean</span>), in the Innu community of Mashteuiatsh. Her work is characterized by spirituality, symbolism, and syncretism. She uses and diverts symbols alluding to the catholic religion. For her, it’s a way to regain her own spirituality. «&ThinSpace;By rejecting the doctrine and all the institutional side of religions, true spirituality emerges.&ThinSpace;» With these symbols that intersect and clash, her work speaks simultaneously of contrast and diversity, duality and balance, injuries and healings. Her double identity, Atikamekw by her father and Quebecer by her mother, allows her to better understand the differences between these two peoples and to create a dialogue through her works.</p>",
        sources: [{ link: "https://www.sacredfireproductions.ca/artists/eruoma-awashish/", name: "Eruoma Awashish&ThinSpace;&ndash;&ThinSpace;Sacred Fire Productions" }, { link: "https://www.concordia.ca/about/community/events/startup-nations/eruoma-awashish.html", name: "Eruoma Awashish&ThinSpace;&ndash;&ThinSpace;Concordia University" }]
      },
      3: {
        name: "Evelyne St-Onge",
        birth: "1980",
        death: "",
        hideDates: false,
        imgSrc: "evelyne_st_onge",
        tags: ["politics"],
        group: ["first"],
        content: "<p>Originally from the Uashat-Maliotenam Innu community, on the North Shore, Evelyne St-Onge has played a leading role in the safeguard, development and transmission of indigenous knowledge. After studying nursing in Montreal, she began a nursing career and married a non-native, a union that caused her to lose her Indian status under the Federal Indian Act. In 1974, she co-founded the Association of Native Women, whose mission is to harmonize relations between Native and non-Native people, between Native communities themselves and, above all, to recognize equal rights between women and men within these communities. She is also involved in the battle to change the Indian Act so that women retain their Indian status following marriage to a non-native. Federal law will finally be amended in 1985.</p><p>Evelyne St-Onge continues her action in the field of education, devoting her efforts to the adoption of the Innu language as the language of instruction and to the integration of Innu practices and traditions into the school curriculum. Its work to raise awareness of various cultural realities, carried out in collaboration with the Human Rights Commission, under the aegis of the Tshakapesh Montagnais Cultural and Educational Institute, reaches 45,000 students in some thirty schools in Quebec. In 1987, the activist participated in the creation of the first production house of indigenous videos in Quebec, <span lang=\"fr\">Productions Manitu</span>, which produced some forty documentaries contributing to the enrichment and influence of Innu culture. In 1994, his mobilization work against the construction of the SM3 dam on the <span lang=\"fr\">Sainte-Marguerite</span> River, which encroaches on native lands, earned him a 10-day prison sentence and two years of supervised release. Despite everything, this mobilization awakens Quebec to the risks of poorly planned resource development.</p><p>From 2010 to 2013, Evelyne St-Onge held the position of adviser of the Maliotenam Reserve and worked to transfer funds from the exploitation of natural resources to education programs. Today, this courageous feminist continues to assert Indigenous claims to numerous regional associations of the <span lang=\"fr\">Fédération des femmes du Québec</span>.</p>",
        sources: [{ link: "https://www.actualites.uqam.ca/2015/uqam-remet-doctorat-honorifique-quatre-personnalites-marquantes", name: "<span lang=\"fr\">Hommage à quatre personnalités marquantes&ThinSpace;&ndash;&ThinSpace;<abbr title=\"Université du Québec à Montréal\">UQAM</abbr></span>" }]
      },
      4: {
        name: "Leona Makokis",
        birth: "<span class=\"review\">1980</span>",
      ...
      5: {
        ...
        tags: ["education"],
        group: ["first"],
        content: "<p>Lise Bastien, Wendat of the Wendake community, holds a bachelor's degree in teaching and a microprogram in public administration (graduate studies). Executive Director of the First Nations Education Council (FNEC), organization that she founded in 1985, she is responsible among other things of achieving results, human resource management and finances. The control of the teachings carrying the heritage of the First Nations is the way towards the academic success of the current and future generations. The organization now has more than 60 employees that made it possible to highlight many issues aimed at improving the education of First Nations youth in particular the establishment of the first First Nations College. The network she has built in recent years is an asset for business influence and successful results-based project management is a major asset for business management.</p><p>Lara Sioui and Lise Bastien founded Onquata in 2018. The <span alng=\"fr\">Econobois</span> company has more than 50 employees and has diversified its products over time. Lise Bastien is responsible for the development of products and production.</p>",
        sources: [{ link: "https://www.cciquebec.ca/imports/medias/images/cohortes/leadershipfeminin/conferencieres/bio-onquata.pdf", name: "<span lang=\"fr\">Les Associés&ThinSpace;&ndash;&ThinSpace;Onquata</span>" }, { link: "https://fernwoodpublishing.ca/authors/view/leona-makokis", name: "<span lang=\"fr\">8<sup>e</sup> Feu&nbsp;: Les Autochtones et le Canada, le sentier de l'avenir&ThinSpace;&ndash;&ThinSpace;Radio-Canada</span>" }]
      },
      6: {
        name: "Honourable Marion Buller",
        birth: "<span class=\"review\">1980</span>",
        death: "",
        hideDates: true,
        imgSrc: "honourable_marion_buller",
        tags: ["law"],
        group: ["first"],
        content: "<p>The Honourable Judge Marion Buller was appointed the first woman First Nations judge in British Columbia in 1994 and was appointed as Chief Commissioner for the National Inquiry into Missing and Murdered Indigenous Women and Girls in 2016. Prior to being appointed to the Provincial Court bench, Judge Buller worked as a civil and criminal lawyer (1988 – 1994). Judge Buller served as both a director and president of Canada’s Indigenous Bar Association and has been a member of the <abbr title=\"British Columbia\">B.C.</abbr> Police Commission, the Law Court Education Society and the Law Foundation of British Columbia. She was the Commission Counsel for the Caribou-Chilcotin Justice Inquiry and published reports and articles dealing with Aboriginal rights and legal services for First Nations in <abbr title=\"British Columbia\">BC</abbr>. Judge Buller was instrumental in starting the First Nations Courts of British Columbia in 2006. She received her bachelor's degree in anthropology from the University of Victoria, and went on to study law there as well. Judge Buller is currently resident in Port Coquitlam, British Columbia, but maintains band membership with the Mistawasis First Nation in Saskatchewan. She retired as a judge in 2016.</p><p>On December 8<sup>th</sup>, 2015, the Liberal government announced the start of the National Inquiry into Missing and Murdered Indigenous Women and Girls. The inquiry was set to conclude at the end of 2018. However, Chief Commissioner Buller requested an extension to the inquiry. The final report released on June 3<sup>rd</sup>, 2019 concluded that the violence faced by indigenous women and girls is caused by state action and inaction. Within the report, Chief Commissioner Buller refers to this ongoing violence as a &ldquo;deliberate, race, identity and gender-based genocide&rdquo;. Among many criticisms of the inquiry was the refusal of the federal government to grant the full two year extension that was requested, which Buller saw as another &ldquo;part of this national tragedy&rdquo;.</p><p>In 2012, Judge Buller received the Distinguished Alumni Award from the UVic Faculty of Social Science. In 2016, Maclean's listed her as one of only six people who might be especially influential on policy in the Trudeau government. She has received numerous other awards, including the Queen's Golden Jubilee which recognizes Albertans who demonstrate leadership and talent in performing and visual arts. She also received the Queen Elizabeth <abbr title=\"2\">II</abbr> Diamond Jubilee Medal which acknowledges Canadian citizens who have greatly contributed to the country and brought great credit to Canada. Finally, she received the Rosemary Brown Award for Women. This award recognizes a British Columbia based woman that promotes the values and ideals which Rosemary Brown championed during her lifetime.</p>",
        sources: [{ link: "https://www.uvic.ca/socialsciences/careers/departments/anthropology/profiles/buller-marion.php", name: "Honourable Marion Buller&ThinSpace;&ndash;&ThinSpace;University of Victoria, Social Sciences" }, { link: "https://en.wikipedia.org/wiki/Marion_Buller", name: "Marion Buller&ThinSpace;&ndash;&ThinSpace;Wikipedia" }]
      },
      7: {
      ...
      12: {
        name: "Amélie Larouche",
        birth: "1982",
        death: "",
        hideDates: false,
        imgSrc: "amelie_larouche",
        tags: ["politics"],
        group: ["first"],
        content: "<p>Chief counselor of the Maliseet of Viger First Nation, Amélie Larouche long ignored her Indigenous roots, since her grandmother kept them hidden. Today, she tries to give pride back to her community. The members of the Maliseet of Viger dispersed after the return of their lands to the Government of Canada in 1870. They left their ancestral territory to spread throughout Quebec and Maine. Many of them continue to hide their origins, or ignore them, laments Amélie Larouche. The Maliseet of Viger First Nation has approximately 1,600 members. Most of its members do not live on reserves, but are spread over several different cities and regions of Quebec and Maine. The Maliseet reserves cover an area of 259 hectares and are located in Cacouna and Whitworth, about thirty kilometers south of <span lang=\"fr\">Rivière-du-Loup</span>.</p><p>From the age of 19, Amélie Larouche has made it her mission to transmit her pride to her community and to help it reaffirm its identity. She already works within the band council and negotiates agreements with the government of Quebec so that the Maliseet can resume hunting on their territory. For the past nine years, Amélie Larouche has been Chief Councilor of the Maliseet of Viger First Nation. After helping her family reclaim their land, she now wants them to know their language and culture better and, above all, to become proud of being Indigenous again.</p>",
        sources: [{ link: "https://ici.radio-canada.ca/espaces-autochtones/1086336/malecite-autochtone-femme-viger-chef", name: "<span lang=\"fr\">Amélie Larouche&nbsp;: de la honte à la fierté d'être Malécite&ThinSpace;&ndash;&ThinSpace;ICI Bas-Saint-Laurent</span>" }]
      },
      13: {
      ...
      14: {
        ...
        tags: ["art"],
        group: ["first"],
        content: "<p>Margaret August is a Two-Spirited, Coast Salish artist from Shíshálh Nation. Margaret was born in 1983 in the traditional unceded Lkwungen and W̱SÁNEĆ territories, now referred to as Victoria <abbr title=\"British Columbia\">B.C.</abbr> Margaret’s work is inspired by their traditional teachings and encounters with nature. Margaret originally began developing their artistic talents at an early age. They carried on with their visual art practice as they became an adult. Some of their artistic influences include renowned artists such as Susan Point, Mark Preston and Butch Dick. Margaret has been showing work in group art shows since 2011, by taking the necessary time to grow as an artist while developing their own style, and in their business skills.</p><p>In 2017, Margaret started working with further training under the guidance and mentorship of fellow Coast Salish Artist, Dylan Thomas to sharpen their skill set towards advancement in Salish art and design. This has led to creating art in multiple mediums such as serigraph/giclee prints, glass, cedar sandblasted pieces and more. Margaret is committed to their art practice as they believe it is their life’s purpose.</p>",
      ...
      16: {
        name: "Melissa Mollen Dupuis",
        birth: "1984",
        death: "",
        hideDates: false,
        imgSrc: "melissa_mollen_dupuis",
        tags: ["art"],
        group: ["first"],
        content: "<p>Melissa Mollen Dupuis is a member of the Innu community of Ekuanitshit on Quebec's <span lang=\"fr\">Côte-Nord</span>. From an Innu mother and a Quebecois father, she tells the story of the blending of cultures through visual arts, animation, performance and storytelling. After a long professional career in which she shared the rich culture of her people with non-Indigenous audiences, she created with Widia Larivière in 2012 the Quebec branch of the Idle No More movement. In 2014, Melissa became president of Wapikoni's board of administrators, and in 2017, Amnesty International named her Ambassador of Conscience along with five other figures of Canada's First Peoples' movement and Alicia Keys. In 2018, she became the Boreal campaigner for the David Suzuki Foundation.</p>",
        sources: [{ link: "http://www.wapikoni.ca/filmmakers/melissa-mollen-dupuis", name: "Melissa Mollen Dupuis&ThinSpace;&ndash;&ThinSpace;Wapikoni Mobile" }, { link: "https://www.jqsi.qc.ca/?Melissa-Mollen-Dupuis", name: "<span lang=\"fr\">Melissa Mollen Dupuis&ThinSpace;&ndash;&ThinSpace;Journées québécoises de la solidarité internationale</span>" }]
      },
      17: {
        name: "Widia Larivière",
        birth: "1984",
        death: "",
        hideDates: false,
        imgSrc: "widia_lariviere",
        tags: ["art"],
        group: ["first"],
        content: "<p>Widia Larivière was born to an Algonquin mother and a Quebec father. She graduated in International Studies and Modern Languages from Laval University and in Immigration and Interethnic Relations from <abbr title=\"Université du Québec à Montréal\" lang=\"fr\">UQAM</abbr>. A feminist activist for indigenous causes, she has fought for the rights of indigenous peoples for several years, with a particular interest in issues affecting youth and women. Since 2009, she has held the position of youth coordinator at Quebec Native Women. She is also one of the co-initiators of the Quebec mobilization of the Idle No More movement. Activist for a rapprochement of peoples, she agreed to be co-spokesperson for the environmental and cultural festival <span lang=\"fr\">Échofête</span> in 2013 and the Quebec Days of International Solidarity in 2014. More recently, she co-directed the short films &ldquo;<span lang=\"fr\">Un nouveau souffle</span>&rdquo; (2014) and &ldquo;Where are your feathers?&rdquo; (2015) thanks to Wapikoni mobile. She has also contributed to books including &ldquo;Women change the struggle&rdquo; (2013), &ldquo;Free to learn&rdquo; (2014), &ldquo;Stolen sisters&rdquo; (2014) and &ldquo;11 brief essays against austerity&rdquo; (2015). Her most recent project: the Mikana organization, whose mission is to work for social change by educating various audiences on Indigenous realities in Canada. Her commitment earned her a Hommage award as part of the 40<sup>th</sup> anniversary of the Charters of Human Rights and Freedoms in 2015. She is also one of the winners of the Top 20 Diversity Personalities of the Year 2015 by <span lang=\"fr\">Médiamosaïque</span>.</p>",
        sources: [{ link: "http://www.wapikoni.ca/cineastes/widia-lariviere", name: "<span lang=\"fr\">Widia Larivière&ThinSpace;&ndash;&ThinSpace;Wapikoni Mobile</span>" }]
      },
      18: {
      ...
      19: {
        name: "Laurie Rousseau-Nepton",
        birth: "1986",
        death: "",
        hideDates: false,
        imgSrc: "laurie_rousseau_nepton",
        tags: ["education"],
        group: ["first"],
        content: "<p>Laurie Rousseau-Nepton is the first indigenous woman in Canada to obtain a <abbr title=\"Philosophi&aelig; doctor\">PhD</abbr> in astrophysics. Innu and member of the Pekuakamiulnuatsh First Nation, she spent part of her childhood in Wendake (Québec) but currently resides in the Big Island of Hawaii and works as a Canadian astronomer at the Canada-France-Hawaii Telescope.</p><p>Rousseau-Nepton received her <abbr title=\"Philosophi&aelig; doctor\">PhD</abbr> in 2017 from <span lang=\"fr\">Université Laval</span>, under the supervision of Prof. Carmelle Robert. Her doctoral research involved studying star formation in galaxies, using a unique astronomical camera called SpIOMM and helped in developing a camera called SITELLE, later installed at the Canada-France-Hawaii Telescope. Since 2017, she has been a resident astronomer at the Canada-France-Hawaii Telescope and is now leading SIGNALS, a large survey program conducted by more than 70 researchers in 17 different countries aiming at observing over 50,000 star-forming regions to understand how stars influence the evolution of our Universe. Her work was awarded a National Science Foundation grant, a <abbr title=\"Fonds québécois de la recherche sur la nature et les technologies\" lang=\"fr\">FRQNT</abbr> postdoctoral scholarship, the Hubert Reeves Fellowship and the Award for native women in sciences of the <span lang=\"fr\">Association des femmes diplômées des universités du Québec</span>. Using her expertise in science and her natural interest for ancestral knowledge, she has started and participates to multiple projects that are focused on highlighting the physics and astronomical knowledge within the First Nations Oral tradition.</p>",
        sources: [{ link: "https://www.physique.usherbrooke.ca/wipc/en/laurie-rousseau-nepton-2/", name: "Laurie Rousseau-Nepton&ThinSpace;&ndash;&ThinSpace;Women in Physics Canada" }, { link: "https://en.wikipedia.org/wiki/Laurie_Rousseau-Nepton", name: "Laurie Rousseau-Nepton&ThinSpace;&ndash;&ThinSpace;Wikipedia" }]
      },
      20: {
        name: "Nancy Saunders",
        birth: "1986",
      ...
      23: {
        ...
        tags: ["education"],
        group: ["first"],
        content: "<p>Anice Ottawa grew up in Manawan, located in the <span lang=\"fr\">Lanaudière</span> region. She did part of her studies in Joliette, the nearest town, and then continued in Quebec. She held administrative functions for the First Nations Education Council. Then, after obtaining a certificate in psychology at the University of Quebec at <span lang=\"fr\">Trois-Rivières</span>, an opportunity arose to work in the AHSUNC (Aboriginal Head Start Program in Urban and Northern Communities) program. She fell in love with children and has been an educator for more than 10 years.</p><p><abbr title=\"Aboriginal Head Start Program in Urban and Northern Communities\">AHSUNC</abbr> is a preschool program launched in 1995, funded by the Public Health Agency of Canada, and reaches 4,600 to 4,800 children each year. In her workshops, Anice Ottawa sings nursery rhymes with children, reads stories to them, talks about their culture and traditions. Pow-wow, banik bread and dream catchers: everything is subject to exchange and discussion. This is what she does every day with the children to whom she tries to transmit the pride of her culture, of her roots.</p><p>The population of <span lang=\"fr\">Trois-Rivières</span> is 134,000 residents. Among them, nearly 150 say their mother tongue is Attikamek, according to the latest data from Statistics Canada.</p>",
        sources: [{ link: "https://ici.radio-canada.ca/espaces-autochtones/1086818/journee-femme-autochtone-attikamek-enfants-langue-culture", name: "<span lang=\"fr\">Faire rayonner la culture atikamekw grâce aux enfants&ThinSpace;&ndash;&ThinSpace;Radio-Canada Espaces Autochtones</span>" }]
      },
      24: {
        name: "Elaine Bomberry",
        birth: "<span class=\"review\">1990</span>",
        death: "",
        hideDates: true,
        imgSrc: "elaine_bomberry",
        tags: ["media"],
        group: ["first"],
        content: "<p>Elaine Bomberry is a trailblazer in the music industry. For the past three decades, she has produced award winning shows like Rez Bluez on <abbr title=\"Aboriginal Peoples Television Network\">APTN</abbr>, and managed Juno award winning artists. Bomberry also helped co-create a Juno award category solely for Indigenous artists. But at the start of her career, there were very few Indigenous people working behind the scenes in the music industry. Bomberry, who is Anishinaabe and Cayuga from Six Nations of the Grand River Territory, had her career come full circle in 2018. During her Juno award acceptance speech for Indigenous Music Album of the Year, Buffy Sainte-Marie dedicated the award to Bomberry.</p><p>On April 3, 1993, she launched Rez Bluez, initially a showcase of Indigenous blues musicians at the Edgewater in Toronto. It rapidly grew into a brand comprising concerts, a radio documentary, workshops and a television show on <abbr title=\"Aboriginal Peoples Television Network\">APTN</abbr>. When she wasn’t creating Rez Bluez, Elaine was booking and managing artists. She was instrumental in establishing the Juno Awards’ Indigenous music category, and she’s been a tireless advocate for Indigenous artists in the Canadian roots and blues scene. And that’s only a sampling of her achievements.</p><p>Bomberry and her husband, Juno award winning Mohawk blues piano man Murray Porter, now call Vancouver home. She has been Porter’s manager for the past 14 years, but has worked with him since 1990. Bomberry recently started writing lyrics and had her first song featured on Porter’s latest album. A recent national Indigenous music impact study conducted for <abbr title=\"Aboriginal Peoples Television Network\">APTN</abbr> found the community is thriving, employing thousands of people. Bomberry says a study like was long overdue and hopes the findings help keep the momentum going.</p>",
        sources: [{ link: "https://www.aptnnews.ca/facetoface/music-industry-trailblazer-elaine-bomberry-says-more-investment-in-artists-needed/", name: "Music industry trailblazer Elaine Bomberry says more investment in artists needed&ThinSpace;&ndash;&ThinSpace;<abbr title=\"Aboriginal Peoples Television Network\">APTN</abbr> National News" }, { link: "https://www.rootsmusic.ca/2020/11/27/derek-andrews-talks-to-elaine-bomberry-about-rez-blues-and-the-indigenous-roots-of-the-blues/", name: "Derek Andrews talks to Elaine Bomberry about Rez Blues and the Indigenous roots of the blues&ThinSpace;&ndash;&ThinSpace;Roots Music Canada" }]
      },
      25: {
        name: "Emma Saganash",
        birth: "<span class=\"review\">1990</span>",
      ...
      26: {
        ...
        tags: ["education"],
        group: ["first"],
        content: "<p>Valerie Gabriel brings a lifetime of experience to her environmental, wildlife and agricultural consulting service. She runs a small-scale food farm, Nations Garlic Farms in Kanesatake, Quebec. After taking a break from farming for a year, Gabriel said it made her want to run an educational business, offering the expertise and knowledge she's accumulated in the field. Nations Garlic Farm is owned and operated by Valerie Gabriel, a 30 year old, single mother of one beautiful daughter. Valerie Gabriel is an environmental and wildlife consultant and through Nations Garlic Farm provides agricultural and cultural learning opportunities and workshops on or off site, and public speaking services through the Kanienkehà:ka (Mohawk) worldview. Other services provided by Nations Garlic Farm is certified organic garlic, seed garlic, dried garlic powder, and medicinal herbs. Currently working as an environmental and agricultural consultant to the Mohawk Communities of Kanesatake and Kahnawà:ke as well as other native, and non-native organizations outside of these two communities. She is currently pursuing a Bachelor's degree at Concordia University.</p>",
        sources: [{ link: "https://kanesatake.ca/wp/nations-garlic-farm/", name: "Valerie Gabriel EWA Consulting Services" }, { link: "https://www.terrahumanasolutions.com/team-members/Valerie-Karonhiatakwen-Gabriel", name: "Valerie Karonhiatakwen Gabriel&ThinSpace;&ndash;&ThinSpace;TerraHumana Solutions" }]
      },
      27: {
      ...
      30: {
        name: "Natasha Kanapé Fontaine",
        birth: "1991",
        death: "",
        hideDates: false,
        imgSrc: "natasha_kanape_fontaine",
        tags: ["art"],
        group: ["first"],
        content: "<p>Born in 1991 in <span lang=\"fr\">Baie-Comeau</span>, Natasha Kanapé Fontaine is Innu, originally from Pessamit on the North Shore. Poet-performer, actress, visual artist and activist for aboriginal and environmental rights, she lives in Montreal. Natasha first marked the territory of Quebec with her &ldquo;territorial&rdquo; Slams in 2012, from Rimouski to Montreal. She has published three critically acclaimed collections of poetry entitled <span lang=\"fr\">N'entre pas dans mon âme avec tes chaussures</span> (<span lang=\"fr\">Mémoire d'encrier</span>, 2012), <span lang=\"fr\">Manifeste Assi</span> (<span lang=\"fr\">Mémoire d'encrier</span>, 2014) and <span lang=\"fr\">Bleuets et abricots</span> (<span lang=\"fr\">Mémoire d'encrier</span>, 2016). With Deni Ellis Béchard, the two writers exchanged letters on racism between Aboriginal and non-Aboriginal people. From this project was born Kuei <span lang=\"fr\">je te salue: conversation sur le racisme</span> (<span lang=\"fr\">Écosociété</span> 2016), proposing dialogue between peoples to young people in schools in Quebec and elsewhere on discrimination and the relationship with the Other. Since then, Kanapé Fontaine continues to travel the territories of Quebec, Canada and now the rest of the world in conferences, performances, and collaborations with artists of all origins. Proud member of the Innu people and inspired by the pan-Canadian Aboriginal movement Idle No More, she travels throughout Quebec, Canada and the world, her message being one of dialogue, reconciliation, healing and exchange between peoples. </p><p>Kanapé Fontaine now sees the publication in English of her collections Don't enter my soul with your shoes and Assi Manifesto (Mawenzi House, Toronto, <abbre title=\"Ontario\">ON</abbr>). In the spring of 2018, Blueberries and Apricots will be published by the same publishers, as well as Kuei my Friend: a conversation on race and reconciliation (Talonbooks, 2018), all translated by award-winning poet Howard Scott. Fontaine's artistic and literary approach aims to bring divergent peoples together through dialogue, exchange, shared values, and the &ldquo;tanning of hides,&rdquo; a metaphorical way of scratching the imperfections of thoughts and consciousness. With poetry, she rocks the Environment and begins a healing process with it. Natasha Kanapé Fontaine fights against racism, discrimination and colonial mentality through speech and poetry, all to ensure a trace, in the process of decolonization, for future generations.</p><p>From 2017 to 2019, Kanapé Fontaine played the role of &ldquo;Eyota Standing Bear&rdquo;, a First Nations incarcerated criminal on the French-Canadian television drama <span lang=\"fr\">Unité 9</span>. And in 2020, she participated in the documentary television show Inked in the skin, in which she gets a tattoo and explains her vision of this body art.</p>",
        sources: [{ link: "https://en.wikipedia.org/wiki/Natasha_Kanap%C3%A9_Fontaine", name: "Natasha Kanapé Fontaine&ThinSpace;&ndash;&ThinSpace;Wikipedia" }, { link: "https://nikamowin.com/en/artist/natasha-kanape-fontaine", name: "Natasha Kanapé Fontaine&ThinSpace;&ndash;&ThinSpace;Nikamowin" }]
      },
      31: {
        name: "Bertha Skye",
      ...
      34: {
        ...
        death: "",
        hideDates: false,
        imgSrc: "jemmy_echaquan_dube",
        tags: ["media"],
        group: ["first"],
        content: "<p>Jemmy Echaquan Dubé is Atikamekw from Manawan. She grew up in her community in Manawan until she was six years old before moving to <span lang=\"fr\">Joliette</span> with her mother and three brothers. At the age of 14, she returned to Manawan to relearn her language. She studied visual arts at the <span lang=\"fr\">Cégep de Trois-Rivières</span> and is passionate about all forms of art such as photography, painting, film, music and dance. She was a professional editor and worked on several corporate projects for different organizations. Jemmy also gives awareness workshops for non-Indigenous. Her participation in the <abbr title=\"United Nations\">UN</abbr> Permanent Forum on Indigenous Issues in 2017-2018 inspired her to sensitize Indigenous youth on becoming leaders and being aware of their rights. She did an internship at the National Film Board of Canada and is currently a spokesperson for the First Nations of Quebec and Labrador Youth Network. With many strings to her bow, Jemmy has several forthcoming projects on her mind, from writing to directing and music. Lately, we see her in a leading role as Daisie Flamand in the series <span lang=\"fr\">Fugueuse</span>.</p>",
        sources: [{ link: "http://www.wapikoni.ca/filmmakers/jemmy-echaquan-dube", name: "Jemmy Echaquan Dubé&ThinSpace;&ndash;&ThinSpace;Wapikoni Mobile" }]
      },
      35: {
        name: "Akina Shirt",
        birth: "1994",
      ...
      37: {
        name: "Maïtée Labrecque-Saganash",
        birth: "1995",
        death: "",
        hideDates: false,
        imgSrc: "maitee_labrecque_saganash",
        tags: ["politics"],
        group: ["first"],
        content: "<p>Born in 1995, the year of the second referendum, Maïtée Labrecque-Saganash, from Waswanipi, a Cree community of Eeyou Istcheegrew, grew up in the suburbs of Quebec City with her mother Élaine, her father&ThinSpace;&ndash;&ThinSpace;the former <abbr title=\"New Democratic Party\">NDP</abbr> <abbr title=\"Membrer of Parliament\">MP</abbr> and former Cree negotiator Romeo Saganash&ThinSpace;&ndash;&ThinSpace;and two siblings, sister Stéphanie and brother Félix. Every summer, the family returned to the woods in <span lang=\"fr\">Baie-James</span>, where his mother ran an outfitter. In school, she said she experienced racism and was bullied for being Indigenous. Maïtée notes that many <span lang=\"fr\">Québécois</span> youth know little about indigenous people other than as what they see in their history books. Her father and his siblings were sent to residential schools, and Maïtée said she deals with the legacy of this experience on a daily basis. Maïtée traveled across Eeyou Istchee with the Footprints: A Walk Through Generations exhibit, which was curated by the Aanischaaukamikw Cree Cultural Institute in Oujé-Bougoumou. In every community, she met a number of residential school survivors. Many talked with her openly about their experiences knowing that her father was a survivor. When she asked them if they ever spoke to their children about it, most said they didn’t.</p><p>Maïtée is a columnist for the Montreal Metro Journal and the NATION magazine. An activist for Indigenous rights, she is also involved in her territory, working at the Cree Health Board as a research assistant and communication technician. Maïtée is making her presence felt. Whether she’s busy being an activist, a journalist, a feminist, a student, a daughter or  simply a member of the Waswanipi Cree Nation, she is determined to make her voice heard. In francophone Quebec, Maïtée has rapidly become a high-profile personality&ThinSpace;&ndash;&ThinSpace;largely thanks to her weekly column in <span lang=\"fr\">Métro</span>, the free Montreal daily newspaper. Identified as a &ldquo;<span lang=\"fr\">Militante crie et étudiante en science politique</span>&rdquo; (Cree activist and political-science student), she has been writing about Indigenous issues since October 2016. That same year she toured Quebec for a project called <span lang=\"fr\">Faut qu’on se parle</span> (We Need To Talk) that included former student leader Gabriel Nadeau-Dubois (now the co-leader of Québec solidaire) and Jean-Martin Aussant (the former leader of Option nationale). Engaging with people either in large public forums or during intimate home visits, they discussed political and social issues with the goal of defining the kind of Quebec that Quebecers want and how socially progressive it should be. For Maïtée, the most important issue facing Indigenous peoples in Quebec is land. &ldquo;Nearly 90% of Waswanipi’s territory has been cut or fragmented. As an Indigenous person I should have the right to live and thrive on my land. It’s alarming when you think that the youth will grow up hunting on clear-cut land. The province has to realize that when they destroy the land they are destroying our way of life, and our language,&rdquo; she stated. Now Maïtée is a familiar voice on television and radio talk shows and is frequently invited to speak at various conferences.</p>",
        sources: [{ link: "https://plus.lapresse.ca/screens/cef74474-61e3-4edb-a634-6affc7048a11__7C___0.html", name: "<span lang=\"fr\">Grande Entrevue&nbsp;: Si Maïtée Labrecque-Saganash était&hellip;&ThinSpace;&ndash;&ThinSpace;La Presse+</span>" }, { link: "https://www.youtube.com/watch?v=78A5Oog6NvE", name: "<span lang=\"fr\">Maïtée Labrecque-Saganash&nbsp;| Le legs de Skoden et la montée de la mémétique autochtone&ThinSpace;&ndash;&ThinSpace;YouTube</span>" }, { link: "http://formersite.nationnewsarchives.ca/young-cree-activist-becoming-quebec-media-star/", name: "A young Cree activist is becoming a Quebec media star&ThinSpace;&ndash;&ThinSpace;The Nation" }]
      },
      38: {
    ...
    d2000: {
      0: {
        name: "Anne Archambault",
        birth: "<span class=\"review\">2000</span>",
        death: "",
        hideDates: true,
        imgSrc: "anne_archambault",
        tags: ["politics"],
        group: ["first"],
        content: "<p>Anne Archambault, who was Grand Chief of the Maliseet Nation of Viger from 1999 to 2016, was honored at the National Assembly of Quebec. She was part of the first delegation of ten people to receive the First Peoples Medal, created out of a desire for recognition and in the wake of the necessary reconciliation with indigenous communities.</p>",
        sources: [{ link: "https://www.ciel103.com/nouvelle/1502-anne-archambault-honoree-a-l-assemblee-nationale-du-quebec", name: "<span lang=\"fr\">Anne Archambault honorée à l'Assemblée Nationale du Québec&ThinSpace;&ndash;&ThinSpace;Ciel FM 103,7</span>" }]
      },
      1: {
        ...
        sources: [{ link: "https://images.ourontario.ca/Partners/SixNPL/SixNPL0031122441T.PDF", name: "Six Nations woman region's first native justice of the peace" }]
      },
      2: {
        name: "Jean Teillet",
        birth: "<span class=\"review\">2000</span>",
        ...
        tags: ["politics"],
        group: ["first"],
        content: "<p>Jean Teillet is Senior Counsel with Pape Salter Teillet LLP and specializes in Indigenous rights law. Jean has long been engaged in negotiations and litigation with provincial and federal governments concerning Métis and First Nation land rights, harvesting rights and self-government. She served as counsel before all levels of court, including lead counsel for the landmark case R. v. Powley in which the Supreme Court of Canada affirmed constitutional protection of Métis harvesting rights. Among other significant Indigenous rights cases, she was co-counsel with Arthur Pape in Taku River Tlingit First Nation v. <abbr title=\"British Columbia\">B.C.</abbr>, the companion case to Haida Nation v. <abbr title=\"British Columbia\">B.C.</abbr>, in which the Supreme Court of Canada established consultation requirements. She is currently a negotiation advisor for the Sto:lo Xwexwilmexw in the <abbr title=\"British Columbia\">BC</abbr> treaty process and was part of the Pape Salter Teillet LLP legal team on the Tlicho Land Claims and Self-Government Agreement negotiations.</p><p>Jean was a founder of the Métis Nation of Ontario and the National Aboriginal Moot. She sits on the <abbr title=\"Missing and Murdered Indigenous Women and Girls\">MMIWG</abbr> Federal Sub-Working group. Jean is past Vice President and Treasurer of the Indigenous Bar Association of Canada and a former member of the Canadian Judicial Council Chairperson’s Advisory Group, the National Research Advisory Committee (Métis National Council) and the Equity Committee of the Law Society of Upper Canada.</p><p>In 2020 Jean’s popular history The North-West is Our Mother won the Carol Shields History Award and was shortlisted for the Canadian Law and Society Association W. Wesley Pue Book Prize. She was awarded the Governor General’s Meritorious Service Cross for service to Canada. She has been made an honorary lifetime member of the Association of Ontario Midwives for her contributions to Ontario midwifery. Jean was awarded the Indigenous Peoples’ Council award by the Indigenous Bar Association and she received a Queen Elizabeth <abbr title=\"2\">II</abbr> Diamond Jubilee Medal and the Law Society of Upper Canada’s first ever Lincoln Alexander Award for community service. Jean has three honorary doctorates from the University of Guelph, the Law Society of Ontario and Windsor University.</p><p>Jean is a frequent author and lecturer on issues surrounding access to justice, Indigenous rights, identity and history. Her annual publication, Métis Law in Canada is the principle resource on Métis rights and case law. She has presented internationally in Russia, Poland, Israel, Japan, United States and China. In Canada, she has spoken at conferences for the National Judicial Institute, Association for Canadian Studies, the Law Society of Ontario, the Ontario Native Justices of the Peace, the Universities of Alberta, Ottawa, Saskatoon and Toronto, among others. She has been on faculty at the Banff Centre and the Allard School of Law where she taught self-government negotiation, methodologies for understanding traditional Indigenous law, constitutional law and Métis law. She frequently lectures at the faculties of law across the country.</p><p>In 2019 Jean wrote a popular history, The North-West is Our Mother: The Story of Louis Riel’s People, the Métis Nation, which was published by HarperCollins and was listed as one of the Globe & Mail’s top 100 books of 2019. She created all four of the replica wampum belts in the collection at the Law School of the University of Toronto. One belt, the Two-Row Wampum Belt, hangs in Flavelle Hall at the Law School. Jean also created another belt for the Stó:lō Xwexwilmexw called the S’ólh Lets’emót Swṓqw’elh. Both the Swṓqw’elh and the Two-Row Wampum Belt are symbols of two different peoples living together with different laws and customs within a relationship built on respect and truth.</p><p>Jean received her LL.B and LL.M from the University of Toronto Faculty of Law. She is called to the bar in British Columbia. Jean has been recognized as a &ldquo;best lawyer&rdquo; in Vancouver by Best Lawyers in Canada and as a &ldquo;leading lawyer&rdquo; nationally by Chambers & Partners. She is ranked as one of the &ldquo;most frequently recommended&rdquo; leading practitioners in the field of Indigenous law in the peer rankings published by Lexpert Magazine.</p>",
        sources: [{ link: "https://pstlaw.ca/jean-teillet/", name: "Jean Teillet IPC (BFA, LL.B, LL.M), Senior Counsel&ThinSpace;&ndash;&ThinSpace;Pape Salter Teillet LLP" }]
      },
      3: {
        name: "Lisa Odjig",
        birth: "<span class=\"review\">2000</span>",
      ...
      4: {
        name: "Melanie Omeniho",
        birth: "<span class=\"review\">2000</span>",
        death: "",
        hideDates: true,
        imgSrc: "melanie_omeniho",
        tags: ["education"],
        group: ["metis"],
        content: "<p>Melanie Omeniho is a descendent of the historical Métis community of <span lang=\"fr\">Lac Ste Anne</span> and is a proud member of the Métis Nation of Alberta. As a young person, Melanie attended meetings and assemblies alongside her mother and other strong Métis women role models who insisted on being included and heard. Her political and advocacy career led her to play a role in the development and incorporation of <span lang=\"fr\">Les Femmes Michif Otipemisiwak</span> (<abbr>LFMO</abbr>) and to her three-term re-election as President by Métis women across the homeland.</p><p>Melanie has extensive experience in the areas of community development, social programming, and family and children services. She has worked to develop programs and advocate on behalf of her community to effect changes to the various social programs to better meet the needs of the Aboriginal community. She received the Queen’s Jubilee Medal in recognition for her work in education, Aboriginal youth and advocating for families involved with Children Services. She sits on the Board of Governors of the Métis Nation as a non-voting member, while ensuring consistently that the interests of Métis women are considered in every decision. She also played a key role in the development of Métis Nation priorities to be addressed at the Permanent Bilateral Mechanism table between the Métis Nation and Canada. Melanie has acted on behalf of the Métis Nation on several critical matters as they relate to the duty to consult and engage.</p><p><span lang=\"fr\">Les Femmes Michif Otipemisiwak</span> is the recognized voice of Métis Women across the homeland. Operating in a democratic, transparent and fiscally accountable manner, they influence public policy and decision making related to concerns and aspirations of Métis women at all levels of Indigenous and Canadian government.</p>",
        sources: [{ link: "https://infonex.com/1352/speakers_card/melanie-omeniho/", name: "Melanie Omeniho&ThinSpace;&ndash;&ThinSpace;Infonex" }, { link: "https://www.canada.ca/en/women-gender-equality/news/2018/05/backgrounder---members-of-the-indigenous-womens-circle.html", name: "Backgrounder&ThinSpace;&ndash;&ThinSpace;Members of the Indigenous Women's Circle&ThinSpace;&ndash;&ThinSpace;Women and Gender Equality Canada" }]
      },
      5: {
        name: "Nancy Crépeau",
        birth: "<span class=\"review\">2000</span>",
        death: "",
        hideDates: true,
        imgSrc: "nancy_crepeau",
        tags: ["education"],
        group: ["first"],
        content: "<p>Nancy Crépeau is a <abbr title=\"Philosophi&aelig; doctor\">PhD</abbr> candidate in Second Language Education at the University of Ottawa. Originally from Senneterre (in Abitibi), she was born to an algo-cree mother (of Anicinabe and Cree origins), and a Quebecois father. The subject of her doctoral thesis is the design and testing of a bilingual (French-Anicinabemowin) metaphonology program in the Anicinabe school setting. For the past fifteen years, she has been particularly involved in the field of education and Indigenous Peoples. She also sat on <abbr title=\"Université du Québec en Abitibi-Témiscamingue\" lang=\"fr\">UQAT</abbr>’s Human Research Ethics Committee as Indigenous representative (2017-2020). She is interested in teaching reading to First Nations children, taking into account their linguistic repertoire and their cultural identity.</p>",
        sources: [{ link: "https://www.colloqueresistances.org/personnes-conferencieres-suite-1", name: "<span lang=\"fr\">Personnes conférencières&ThinSpace;&ndash;&ThinSpace;Colloque Résistances</span>" }, { link: "https://education.uottawa.ca/en/news/welcome-new-professors-nancy-crepeau-and-eliane-dulude", name: "Welcome New Professors: Nancy Crépeau and Eliane Dulude&ThinSpace;&ndash;&ThinSpace;University of Ottawa" }]
      },
      6: {
        name: "Odile Joannette",
        birth: "<span class=\"review\">2000</span>",
        death: "",
        hideDates: true,
        imgSrc: "odile_joannette",
        tags: ["media"],
        group: ["first"],
        content: "<p>Odile Joannette was the Executive Director of Wapikoni Mobile, until 2021. She has been working for nearly twenty years to defend and promote the rights of Indigenous peoples and to improve their living conditions. She has served on the Council of the <span lang=\"fr\">Ordre de Montréal</span> from 2017 to 2019 and is one of the fifteen members of the <span lang=\"fr\">Table sur la diversité, l’inclusion et la lutte contre les discriminations</span> of the City of Montréal. A graduate of <abbr title=\"Université du Québec à Montréal\" lang=\"fr\">UQAM</abbr>, specialized in communications and public relations, she became involved in 2002 in the Quebec Native Women’s Movement. In 2007, she collaborated on the development and opening of the first Indigenous early-childhood centre in Montréal and helped create the Montreal Indigenous Community NETWORK. She is a founding member and administrator of<span lang=\"fr\"> DestiNATIONS: Carrefour International des Arts et Cultures des Peuples autochtones</span> and continues her commitment to ensure that Montréal finally has a major cultural and tourist infrastructure.</p><p>She was Director of Partnerships and Communications at <span lang=\"fr\">Commission responsable du développement des ressources humaines, de l’emploi et de la formation</span> for the Assembly of First Nations of Quebec and Labrador before accepting the position of Executive Director for the Wapikoni Mobile. Odile Joannette sees artistic expression as a powerful agent of transformation and is a strong advocate for narrative sovereignty. She inspired Wapikoni’s multi-generational collective to use the organization’s tools and services to broadcast the expertise, know-how and artistic signature of Indigenous people among the public and in the media in Canada and abroad. She will carry on her mission of promoting Indigenous art and culture at the Canada Council for the Arts, where she will lead the &ldquo;Creating, Knowing and Sharing: The Arts and Cultures of First Nations, Inuit and Métis Peoples&rdquo; initiative.</p>",
        sources: [{ link: "http://www.wapikoni.ca/actualites/nouvelles/le-wapikoni-annonce-le-depart-dodile-joannette", name: "<span lang=\"fr\">Le wapikoni annonce le départ d'Odile Joannette&ThinSpace;&ndash;&ThinSpace;Wapikoni Mobile<span>" }, { link: "http://colloques.uqac.ca/prscpp/odile-joannette/", name: "<span lang=\"fr\">Odile Joannette&ThinSpace;&ndash;&ThinSpace;<abbr title=\"Université du Québec à Chicoutimi\">UQAC</abbr></span>" }]
      },
      7: {
        name: "Sandrine Filiatrault",
        birth: "<span class=\"review\">2000</span>",
        death: "",
        hideDates: true,
        imgSrc: "sandrine_filiatrault",
        tags: ["healthcare"],
        group: ["first"],
        content: "<p>A young Huron-Wendat woman, Sandrine is currently living in Montreal for her medical studies. In her first year of study, she decided to join the <abbr title=\"Groupe d’intérêt en santé autochtone\" lang=\"fr\">GISA</abbr> (Indigenous Health Interest Group) university group. Besides going to Uashat, Mingan, Natashquan and Pakua Shipi as part of this project, she decided on her own to set up the project with Pessamit, which took place in October, but this time involving Laval University so that this project takes on scale. Through her participation in <abbr title=\"Groupe d’intérêt en santé autochtone\" lang=\"fr\">GISA</abbr>, Sandrine also organized a symposium on indigenous cultural competence, which welcomes more than 150 people annually and covers topics ranging from indigenous law to medicinal plants.</p><p>The First Nations and Inuit Faculties of Medicine Program in Quebec (<abbr title=\"Programme des facultés de médecine pour les Premières Nations et les Inuits au Québec\" lang=\"fr\">PFMPNIQ</abbr>) allows four Quebec students to be admitted to the medical doctorate program each year under certain conditions. In 2014, Sandrine was admitted and did not take long to choose between the various medical schools in Quebec.</p>",
        sources: [{ link: "https://www.faq-qnw.org/news/faq-remet-la-premiere-bourse-otehiminan-a-deux-recipiendaires/", name: "<span lang=\"fr\">FAQ remet la première bourse Otehiminan à deux récipiendaires&ThinSpace;&ndash;&ThinSpace;Femmes autochtones du Québec, Inc.</span>" }, { link: "https://admission.umontreal.ca/objectif-udem/article/de-wendake-a-montreal-portrait-de-sandrine-filiatrault-etudiante-autochtone-en-medecine/", name: "<span lang=\"fr\">De Wendake à Montréal&nbsp;: portrait de Sandrine Filiatrault, étudiante autochtone en médecine&ThinSpace;&ndash;&ThinSpace;Université de Montréal</span>" }]
      },
      8: {
        name: "Shushan Bacon",
        birth: "<span class=\"review\">2000</span>",
        death: "",
        hideDates: true,
        imgSrc: "shushan_bacon",
        tags: ["media"],
        group: ["first"],
        content: "<p>Shushan is a proud Innu from the community of Uashtat mak Mani-Utenam who joined the <span lang=\"fr\">Nouvelles Nationales d’<abbr title=\"Aboriginal Peoples Television Network\" lang=\"en\">APTN</abbr></span> team as a correspondent in Montreal. She grew up in Wendake and studied public communications at Laval University in Quebec City. She did an internship in the summer of 2001 as a journalist at <abbr title=\"Aboriginal Peoples Television Network\" lang=\"en\">APTN</abbr> and is pleased to be back!</p>",
        sources: [{ link: "https://www.aptnnews.ca/author/sbacon/", name: "Shushan Bacon&ThinSpace;&ndash;&ThinSpace;<abbr title=\"Aboriginal Peoples Television Network\">APTN</abbr> National News" }]
      },
      9: {
        name: "Sylvie Ambroise",
        birth: "<span class=\"review\">2000</span>",
        death: "",
        hideDates: true,
        imgSrc: "sylvie_ambroise",
        tags: ["media"],
        group: ["first"],
        content: "<p>Sylvie Ambroise, from Uashat-Maliotenam, this week became the Pierre Bruneau of TVA among the indigenous peoples. Her story is living proof that effort, persistence and passion lead to her dreams. Born in Maliotenam, she grew up there and stayed there throughout her adolescence. Studies will force her to leave family and friends for the big metropolis.</p><p>Enrolled in <span lang=\"fr\">Cégep du Vieux-Montréal</span> in architectural techniques, she will continue her studies at the University of Quebec in Montreal, in political science, to perhaps follow in the footsteps of her late father, Chrysologue Ambroise, head of Uashat-Maliotenam from 1982 to 1988.</p><p>Well no! Her dream: to become a journalist. Back in her community to come and take care of her sick parents, she will occupy positions in administration and communication within the Uashat-Maliotenam Band Council. Still obsessed with the fear of not achieving her dream one day, she turns her back on a permanent job with good working conditions to embark on the adventure of the exciting but precarious profession of journalism. Without a net, she dives. A go-getter, she opens a first door, that of the Innuvelle newspaper.</p><p>At 36, with no experience or training in journalism, she rose through the ranks, one step at a time, from advertising representative to journalist. With as first assignment the film by Kevin Bacon-Hervieux on the indigenous Innu Nikamu festival&ThinSpace;&ndash;&ThinSpace;prize for best documentary at the <span lang=\"fr\">Gala Québec cinema</span> in 2019&ThinSpace;&ndash;&ThinSpace;Sylvie Ambroise discovers her pen and will refine it for two years.</p>",
        sources: [{ link: "https://macotenord.com/une-innue-realise-son-reve-de-petite-fille/", name: "<span lang=\"fr\">Une Innue réalise son rêve de petite fille&ThinSpace;&ndash;&ThinSpace;Ma Côte-Nord</span>" }]
      },
      10: {
        name: "Tania Larivière",
        birth: "<span class=\"review\">2000</span>",
        death: "",
        hideDates: true,
        imgSrc: "tania_lariviere",
        tags: ["education"],
        group: ["first"],
        content: "<p>Tania Larivière is a young Anishinabe woman who was raised within Eenou culture. As an indigenous youth advocate, she strives to bridge the intergenerational gap caused by the modern indigenous experience and traditions passed down through ancestral knowledge. Currently, she works for the Cree Nation Youth Council as their current Special Projects Officer.</p>",
        sources: [{ link: "https://www.youtube.com/watch?v=IqdXIZ5CnCg", name: "<span lang=\"fr\">Tania Lariviere&nbsp;| Bâtir les ponts d’un monde à l’autre&ThinSpace;&ndash;&ThinSpace;YouTube</span>" }]
      },
      11: {
        name: "Joan Beatty",
      ...
      19: {
        ...
        sources: [{ link: "https://soundingsjohnbarker.wordpress.com/tag/judge-doreen-redhead/", name: "Tag Archives: Judge Doreen Redhead&ThinSpace;&ndash;&ThinSpace;Soundings John Barker" }, { link: "https://en.wikipedia.org/wiki/Doreen_Redhead" , name: "Doreen Redhead&ThinSpace;&ndash;&ThinSpace;Wikipedia" }]
      },
      20: {
      ...
      26: {
        name: "Adrienne Anichinapeo",
        birth: "<span class=\"review\">2010</span>",
        death: "",
        hideDates: true,
        imgSrc: "adrienne_anichinapeo",
        tags: ["politics"],
        group: ["first"],
        content: "<p>Adrienne Anichinapeo is the former First Nations chief of the Anicinape Community of Kitcisakik. Currently, the community of Kitcisakik has no permanent installation such as running water, electricity and basic sanitation. However, steps are currently underway with the Government of Quebec and Canadian authorities to build a permanent village with modern infrastructures. Before 2010, children from the age of five years old were forced to exile in <span lang=\"fr\">Val d'Or</span> which is located 120 kilometers from their village and live in family pension from Sunday to Friday to go to school. The opening of Mikizisec elementary school in 2010 helped to end this situation for the youngest, but high school students always need travel to pursue their studies.</p><p>In 2018, during the inquiry into murdered and missing Indigenous women and girls in Montreal, Adrienne Anichinapeo testified about the different kinds of violence that persist in her Algonquin community. The cycle of violence in Kitcisakik, about 90 kilometres south of <span lang=\"fr\">Val d'Or</span> still continues. Her mother was married at 14 and was physically abused most of her life. Now as an adult, Anichinapeo says she experienced harassment before she was chief, during and after. The members of the Kitcisakik community have long been considered as &ldquo;squatters&rdquo; on their own territory and do not have reserve status under the Indian Act.</p>",
        sources: [{ link: "https://www.anishinabenation.ca/en/the-algonquin-communities/anicinape-de-kitcisakik-community/", name: "Anicinape de Kitcisakik Community&ThinSpace;&ndash;&ThinSpace;Anishinabe Nation" }, { link: "https://montreal.ctvnews.ca/mmiwg-in-montreal-former-chief-testifies-about-cycle-of-violence-in-her-community-1.3844901", name: "<abbr title=\"Missing and Murdered Indigenous Women and Girls\">MMIWG</abbr> in Montreal: Former chief testifies about cycle of violence in her community" }]
      },
      27: {
      ...
      28: {
        ...
        death: "",
        hideDates: true,
        imgSrc: "edith_belanger",
        tags: ["literature"],
        group: ["first"],
        content: "<p>Edith loves to pass on her knowledge in a spirit of openness and sharing. A university graduate in philosophy, she also studied law and management before becoming a professional in Dolfino method hypnosis. She is a columnist for <span lang=\"fr\">Radio-Canada</span>’s Indigenous Spaces in addition to pursuing a master's degree at the National School of Public Administration (<abbr>ENAP</abbr>). For more than 10 years, she has been interested in the unsuspected powers of the brain, anthropology and existential questions. From an early age, she shared her ideas by writing inspirational texts that change people's perspectives. As a member of the Maliseet of Viger First Nation, she is proud of her Métis origins and places great importance on the preservation and sharing of indigenous traditional knowledge, particularly in herbal medicine and ritual practices. In addition to taking care of her four children, Edith is passionate about her work within the Dolfino team which combines project management, animation and coordination of events that she prefers, writing books and articles by blog.</p>",
        sources: [{ link: "https://dolfino.tv/author/edith/", name: "Edith Bélanger&ThinSpace;&ndash;&ThinSpace;Dolfino" }, { link: "https://www.rumeurduloup.com/a-la-recherche-de-la-langue-perdue-avec-edith-belanger-et-dave-jenniss/", name: "<span lang=\"fr\">À la recherche de la langue perdue avec Édith Bélanger et Dave Jenniss&ThinSpace;&ndash;&ThinSpace;Rumeur du loup</span>" }]
      },
      29: {
      ...
      30: {
        ...
        death: "",
        hideDates: true,
        imgSrc: "julie_philippe",
        tags: ["law"],
        group: ["first"],
        content: "<p>Julie Philippe, member of the Innu community of Mashteuiatsh, is the first indigenous woman to access the bench in Quebec. A graduate of the University of Sherbrooke in 2004, Julie Philippe joined the administrative team of the Faculty of Law from 2017 to 2019 as the Recruitment and Indigenous Affairs Coordinator. She was a partner in <span lang=\"fr\">Linteau Soulière</span> law firm and practiced in civil, commercial and family litigation. Coming from the Pekuakamiulnuatsh First Nation, in the community of Mashteuiatsh, in <span lang=\"fr\">Lac-Saint-Jean</span>, she is very involved in the Aboriginal community, previously serving as vice-chair of the board of directors of The First Peoples Justice Center of Montreal and president of the board of directors of the Rising Sun indigenous childcare centre. Me Philippe is also a member of the Canadian Bar Association (<abbr>ABC</abbr>) and of the Quebec Family Lawyers Association (<abbr>AAADFQ</abbr>). </p>",
        sources: [{ link: "https://www.usherbrooke.ca/actualites/nouvelles/facultes/droit/droit-details/article/43354/", name: "<span lang=\"fr\">Julie Philippe, première femme autochtone nommée à la magistrature&ThinSpace;&ndash;&ThinSpace;Université de Sherbrooke</span>" }, { link: "https://www.rcinet.ca/fr/2020/09/11/une-premiere-femme-autochtone-nommee-a-la-magistrature-du-quebec/", name: "<span lang=\"fr\">Une première femme autochtone nommée à la magistrature du Québec&ThinSpace;&ndash;&ThinSpace;Radio-Canada International</span>" }]
      },
      31: {
        name: "Kluane Adamek",
        birth: "<span class=\"review\">2010</span>",
        death: "",
        hideDates: true,
        imgSrc: "kluane_adamek",
        tags: ["politics"],
        group: ["first"],
        content: "<p>Kluane Adamek, she/her/hers (traditional name is &ldquo;Aagé&rdquo;), has served as the Assembly of First Nations (AFN) Yukon Regional Chief since January 2018. She is a proud northerner and citizen of Kluane First Nation. Regional Chief Adamek belongs to the Dakl’aweidi (Killerwhale) Clan and comes from a diverse background with Tlingit, Southern Tutchone, German and Irish origins. After completing a Bachelor of Arts in Canadian Studies from Carleton University in 2009, she returned home to work with Yukon First Nations and local communities in the areas of education, economic development and governance. In 2019, she completed her Master of Business Administration at Simon Fraser University. Throughout her career she has served on a number of boards and committees including the Yukon College Board of Governors, Kluane Dana Trust, Actua, the Aboriginal Healing Foundation, and the Aboriginal Sport Circle.</p><p>She has proven experience in both the private and public sectors, and in Government. While pursuing her Jane Glassco Northern Fellowship with the Walter and Duncan Gordon Charitable Foundation, she led and founded &ldquo;Our Voices,&rdquo; a collective of northern Indigenous emerging leaders and is incredibly passionate about supporting youth and emerging leaders in the North and beyond. Regional Chief Adamek currently holds the <abbr title=\"Assembly of First Nations\">AFN</abbr> National Portfolios for Climate Change and the Environment, Youth and Modern Treaties. She continues to press for changes in the ways young people and the next generation are included in decision making forums, and she is committed to advancing solutions and approaching leadership from a place of values.</p>",
        sources: [{ link: "https://afnyukon.ca/about/regional-chief/", name: "About the Regional Chief&ThinSpace;&ndash;&ThinSpace;Assembly of First Nations Yukon" }]
      },
      32: {
      ...
      33: {
        name: "Manon Jeannotte",
        birth: "<span class=\"review\">2010</span>",
        death: "",
        hideDates: true,
        imgSrc: "manon_jeannotte",
        tags: ["politics"],
        group: ["first"],
        content: "<p>Manon Jeannotte is the former chief of the Mi'gmaq of Gespeg located more than 900 kilometers northeast of Montreal. For the mandate from 2015 to 2019, this council was made up of the chief Manon Jeannotte and eight advisers. Gespeg's situation is unique in Quebec. According to Ms. Jeannotte, most of its 1,800 members live off reserve, near urban centers. She is a consultant in business development and governance for First Nations, scholarship holder of the McGill <abbr>HEC</abbr> and <abbr>ASC</abbr> <abbr>EMBA</abbr> program. Manon completed her <abbr>EMBA/abbr> while she was chief of the Micmac Nation of Gespeg. This role drew a whole new perspective to her studies. These colleagues were thinking about ways of integrating the acquired notions into their company; so she was more interested in putting them into practice in First Nation government. She is now responsible for the development of business strategies for the community of Kanesatake. Her objective: to encourage business development and economic development in an environment that is more focused on community development.</p>",
        sources: [{ link: "https://www.lapresse.ca/xtra/2020-10-20/emba-mcgill-hec-montreal/accueillir-les-leaders-d-exception-des-premieres-nations.php", name: "<span lang=\"fr\">Accueillir les leaders d’exception des Premières Nations&ThinSpace;&ndash;&ThinSpace;La Presse</span>" }, { link: "https://www.aptnnews.ca/national-news/mohawk-migmaq-in-quebec-join-forces-for-inter-nation-vaccination-clinic/", name: "Mohawk, Mi’gmaq in Quebec join forces for &lsquo;Inter-Nation Vaccination Clinic&rsquo;" }, { link: "https://fr.wikipedia.org/wiki/Nation_micmaque_de_Gespeg", name: "<span lang=\"fr\">Nation micmaque de Gespeg&ThinSpace;&ndash;&ThinSpace;Wikipédia</span>" }]
      },
      34: {
        name: "Sheila North",
        birth: "<span class=\"review\">2010</span>",
        ...
        tags: ["politics", "media"],
        group: ["first"],
        content: "<p>Sheila North, known as a &ldquo;bridge builder&rdquo;, is a member of Bunibonibee Cree Nation and was elected as Grand Chief of Manitoba Keewatinowi Okimakanak (<abbr>MKO</abbr>) in September 2015, the first women to hold the position. Previous to this, she enjoyed a career as the Chief Communication Officer at Assembly for Manitoba Chiefs, a <abbr title=\"Canadian Broadcasting Corporation\">CBC</abbr> journalist and <abbr>CTV</abbr> correspondent, an economic development officer, a radio personality and a Cree translator. Sheila holds a diploma in Business Accounting and Rural Development with a focus on community development, a certificate in radio and television broadcasting and a diploma in Creative Communications. Sheila is passionate about the issue of missing and murdered Indigenous women (<abbr>MMIW</abbr>). With this in mind, she created the hashtag, #<abbr title=\"missing and murdered Indigenous women\">MMIW</abbr> which is now commonly used on social media. She continues to work closely with families, friends, as well as Indigenous and non- Indigenous leaders to advance the political will to address racism and the issues around violence against Indigenous people. In recent years, Sheila has co-produced with Leonard Yakir, a TV documentary &ldquo;1200+, part-1&rdquo; highlighting some of the systemic issues that place Indigenous women at greater risk for violence and sexual exploitation.</p><p>Sheila is a gifted writer, a Radio Television Digital News Association award winner and Gemini Award nominee. In 2015, Sheila was featured in <span lang=\"fr\">Chatelaine</span> Magazine as one of the &ldquo;Top 30 Women of 2015&rdquo; and by media personality Ace Burpee from Virgin Radio as one of the &ldquo;Most Fascinating 100 Manitobans to Watch.&rdquo;</p><p>In November 2016, she appealed to federal Prime Minister Justin Trudeau to accept an invitation to visit Shamattawa First Nation after a fire destroyed the only grocery store in the nation. In 2017, she addressed the federal parliament's Indigenous and Northern Affairs Committee over the country's failure to compensate First Nations for hydropower development, as was agreed in the Northern Flood Agreement. After her term ended as Grand Chief of Manitoba Keewatinowi Okimakanak (<abbr>MKO</abbr>), she contested the 2018 Assembly of First Nations leadership election, finishing as runner up to incumbent Perry Bellegarde with 23,9% of the second ballot vote. In 2021, she announced she would be running to lead the Assembly of Manitoba Chiefs, aiming to become the first woman in history to become <abbr title=\"Assembly for Manitoba Chiefs\">AMC</abbr> Grand Chief.</p>",
        sources: [{ link: "https://en.wikipedia.org/wiki/Sheila_North", name: "Sheila North&ThinSpace;&ndash;&ThinSpace;Wikipedia" }, { link: "https://legacybowes.com/our-team/112-sheila-north", name: "Our Team&ThinSpace;&ndash;&ThinSpace;Legacy Bowes" }]
      },
      35: {
        name: "Viviane Michel",
        birth: "<span class=\"review\">2010</span>",
        death: "",
        hideDates: true,
        imgSrc: "viviane_michel",
        tags: ["education"],
        group: ["first"],
        content: "<p>Viviane Michel is from Maliotenam. She is currently president of Quebec Native Women (<abbr>QNW</abbr>). She has been involved for over 10 years in <abbr title=\"Quebec Native Women\">QNW</abbr>, first as director of the Innu Nation, then as Vice-President of the Association from 2010 to 2012. Bilingual, French and Innu Viviane Michel is a woman of tradition who makes it a point of honor to promote the traditional practices of her nation and to promote respect for the identity and culture of Indigenous nations and women. Her career as a frontline worker for the Missinak Aboriginal women shelter in Quebec led her to become familiar with the issues related to Aboriginal women. She also sat on the Aboriginal women shelters Network in Quebec coordinated by <abbr title=\"Quebec Native Women\">QNW</abbr> which has developed many tools to adapt services to the cultural realities of Aboriginal women. In May of this year, Viviane travelled to her community as part of the community consultations organized by <abbr title=\"Quebec Native Women\">QNW</abbr> and PASC on the gendered impacts of resource extraction.</p>",
        sources: [{ link: "https://www.kairoscanada.org/people/viviane-michel#:~:text=Viviane%20Michel%20is%20from%20Maliotenam,Association%20from%202010%20to%202012.", name: "Viviane Michel&ThinSpace;&ndash;&ThinSpace;Kairos Canada" }]
      },
      36: {
        ...
        sources: [{ link: "https://indspire.ca/laureate/gabrielle-scrimshaw-2/", name: "Gabrielle Scrimshaw, Youth Recipient (2013)&ThinSpace;&ndash;&ThinSpace;Indspire" }, { link: "https://www.gabriellescrimshaw.com/", name: "About Gabrielle&ThinSpace;&ndash;&ThinSpace;Gabrielle Scrimshaw" }]
      },
      /*26: {
      ...
      42: {
        name: "Councillor Bernice Martial",
        ...
        tags: ["politics"],
        group: ["first"],
        content: "<p>Bernice Martial was born, raised, and lived most of her life on the Cold Lake First Nations (<abbr>CLFN</abbr>) reserve, located in east-central Alberta. She is a fluent Denesųłiné speaker and traditional knowledge holder of her nation. Bernice Martial was elected in the summer of 2019 to serve a three-year term as a Councillor for <abbr title=\"Cold Lake First Nations\">CLFN</abbr>. Prior to this, Bernice served two consecutive terms of office as the elected Chief&ThinSpace;&ndash;&ThinSpace;from 2013 to 2016, and again from 2016 to 2019&ThinSpace;&ndash;&ThinSpace;as well as a term on Council from 1989 to 1991.</p><p>Bernice Martial was appointed as the first ever female Grand Chief of the Confederacy of Treaty Six First Nations in November 2014, where she served this office until July 2015. She is also a Certified Addictions Counsellor and has served in various capacities supporting <abbr title=\"Cold Lake First Nations\">CLFN</abbr> community and recreational development. Bernice is a mother of two children and has two grandchildren. She also helped raise several of her nieces and nephews. Her personal interests include travelling and practising traditional cultural activities like berry-picking and food preservation.</p><p>Another Recognition: Recognition Award from Alberta Aboriginal Achievement Award for Economic Development.</p>",
      ...
      49: {
        ...
        tags: ["politics"],
        group: ["first"],
        content: "<p>Melanie Mark's (Hli Haykwhl Ẃii Xsgaak) story is one of firsts. She became <abbr title=\"British Columbia\">B.C.</abbr>’s first female First Nations <abbr title=\"Member of the Legislative Assembly\">MLA</abbr> when she was elected to represent Vancouver-Mount Pleasant in 2016. In 2017, she became the province’s first female First Nations cabinet minister, appointed to the Ministry of Advanced Education, Skills and Training. As the first in her family to graduate from high school and complete post-secondary education, Melanie knows the transformative power of education. She is committed to breaking down barriers to education at all access points. Melanie is Nisga’a, Gitxsan, Cree, Ojibway, French and Scottish. She has deep roots in northern <abbr title=\"British Columbia\">B.C.</abbr> and grew up in the projects of East Vancouver. Melanie is currently a mother of two girls.</p><p>Before entering politics, Melanie advocated for youth, the homeless, sexually exploited children and Indigenous peoples in the justice system. She co-founded the Vancouver Aboriginal Community Policing Centre, led a national project with Save the Children Canada, and served as an advocate with British Columbia’s Office of the Representative for Children and Youth. She holds a bachelor of arts degree in political science with a minor in sociology from Simon Fraser University, a criminology diploma from Native Education College/Douglas College and an advanced executive certificate in general management from Queen’s School of Business in Kingston, <abbr title=\"Ontario\">Ont</abbr>.</p>",
