  ...
  persons: {
    ...
    d1980: {
      ...
      18: {
        ...
        tags: ["education"],
        group: ["first"],
        content: "<p>Laurie Rousseau-Nepton is a Canadian astronomer at the Canada-France-Hawaii Telescope and postdoctoral researcher at the University of Hawaii, and is the first indigenous woman in Quebec to obtain a <abbr title=\"Philosophi&aelig; doctor\">PhD</abbr> in astrophysics. She is Innu and she spent most part of her childhood in Wendake (Québec) but now currently resides in the Big Island of Hawaii.</p><p>Rousseau-Nepton received her <abbr title=\"Philosophi&aelig; doctor\">PhD</abbr> in 2017 from University of Laval, under the supervision of Prof. Carmelle Robert. Her doctoral research involved studying the HII regions of nearby spiral galaxies, using the SpIOMM, a imaging Fourier transform spectrometer developed at University of Laval. Since 2017, she has been a resident astronomer at the Canada-France-Hawaii Telescope. She is also the Principal Investigator for SIGNALS, a large survey program aiming at observing over 50,000 resolved star-forming regions in nearby galaxies. Her expertise now allows her to train other researchers to use those tools. Laurie Rousseau-Nepton is presently a <abbr title=\"Fonds québécois de la recherche sur la nature et les technologies\" lang=\"fr\">FRQNT</abbr> postdoctoral scholarship recipient and was previously received the Hubert Reeves Fellowship and the Award for native women in sciences of the <span lang=\"fr\">Association des femmes diplômées des universités du Québec</span>.</p>",
